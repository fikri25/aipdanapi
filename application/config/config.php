...
$config['cookie_path']		= '/';
// $config['cookie_secure']	= TRUE;  //diubah dari false ke true utk penutupan celah karna menggunakan https
$config['cookie_secure']	= FALSE;  //diubah karna menggunakan http
