...
class Aspek_operasional extends CI_Controller {
	...
	public function index(){
        ...
        $data['view']  = "tahunan/aspek_operasional/index-pembayaran-kelompok";
    ...
    public function pembayaran_pensiun_aip(){
        ...
        $data['opt_user'] = dtuser();
        $data['data_kelompok'] = $this->aspek_operasional_th_model->getdata('pembayaran_pensiun_kelompok', 'result_array','2');
        $data['data_jenis'] = $this->aspek_operasional_th_model->getdata('pembayaran_pensiun_jenis', 'result_array','2');

        $data['data_pembayaran_pensiun_aip_ket_thn'] = $this->aspek_operasional_th_model->get_ket('ket_lkao_pembayaran_pensiun_aip');
    ...
    public function pembayaran_pensiun_cabang(){
        ...
        $data['data_pembayaran_pensiun_cbg_ket_thn'] = $this->aspek_operasional_th_model->get_ket('ket_lkao_pembayaran_pensiun_cbg');

        $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');

        if($this->iduser == "TSN002" || $this->iduser == "DJA001"){
            $data['view']  = "tahunan/aspek_operasional/index-pembayaran-cabang-tsn";
        }else{
            $data['view']  = "tahunan/aspek_operasional/index-pembayaran-cabang-asb";
        }
        // echo '<pre>';
        // print_r($data);exit;
        $this->load->view('main/utama', $data);
    ...
    public function nilai_tunai(){
        ...
        $data['data_nilai_tunai_ket_thn'] = $this->aspek_operasional_th_model->get_ket('ket_lkao_nilai_tunai');

        $data['nilai_tunai_detail'] = $this->aspek_operasional_th_model->getdata('nilai_tunai_detail', 'result_array');
        $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
        $data['view']  = "tahunan/aspek_operasional/index-nilai-tunai-header";
        // echo '<pre>';
        // print_r($data);exit;
        $this->load->view('main/utama', $data);
    }
    ...
    public function beban(){
        ...
        $data['sum'] = $this->aspek_operasional_th_model->getdataindex('aset_investasi_front_sum', 'row_array', 'BEBAN INVESTASI');
        $data['tenaga_kerja'] = $this->aspek_operasional_th_model->getdata('data_beban_tenaga_kerja', 'result_array');

        $data['data_beban_ket_thn'] = $this->aspek_operasional_th_model->get_ket('ket_lkao_beban');
        $data['data_kebijakan_ket_thn'] = $this->aspek_operasional_th_model->get_ket('ket_kebijakan_alokasi_thn');

        $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
        $data['view']  = "tahunan/aspek_operasional/index-beban";
        $this->load->view('main/utama', $data);
    }
    ...
    function get_form($mod){
        ...
        switch($mod){
            case 'pembayaran_pensiun_aip':
                ...
                $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
                $data['view']  = "tahunan/aspek_operasional/input-pembayaran-aip";
            ...
            case 'pembayaran_pensiun_aip_cabang':
                ...
                $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
                $data['view']  = "tahunan/aspek_operasional/input-pembayaran-aip-cabang";
            ...
            case 'nilai_tunai':
                ...
                $data['cabang'] = $this->aspek_operasional_model->get_combo('mst_cabang');
                $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
                $data['view']  = "tahunan/aspek_operasional/input-nilai-tunai";
            ...
            case 'beban_tenaga_kerja':
                ...
                $data['cabang'] = $this->aspek_operasional_model->get_combo('mst_cabang');
                $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
                $data['view']  = "tahunan/aspek_operasional/input-beban-tenaga-kerja";
    ...
    function cetak($mod=""){
        ...
        switch($mod){
            case "nilai_tunai_cetak":
                ...
                $data['nilai_tunai_header'] = $this->nilai_tunai_header();
                $data['nilai_tunai_detail'] = $this->aspek_operasional_th_model->getdata('nilai_tunai_detail', 'result_array');
                $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-nilai-tunai-cetak', $data,true);  
            ...
            case 'pembayaran_pensiun_aip_cetak':
                ...
                $data['data_kelompok'] = $this->aspek_operasional_th_model->getdata('pembayaran_pensiun_kelompok', 'result_array','2');
                $data['data_jenis'] = $this->aspek_operasional_th_model->getdata('pembayaran_pensiun_jenis', 'result_array','2');
                $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-pembayaran-aip-cetak', $data,true);  
                $this->hasil_output('pdf',$mod,'', $data, '', "A4", $template, "ya", "no");
            break;
            case 'pembayaran_pensiun_cabang_cetak':
                ...
                if($data['iduser'] == ""){
                    if($this->iduser == "TSN002"){
                        $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-pembayaran-cabang-tsn-cetak', $data,true);  
                    }else if ($this->iduser == "ASB003") {
                        $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-pembayaran-cabang-asb-cetak', $data,true); 
                    }
                }else{
                    if($data['iduser'] == "TSN002"){
                        $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-pembayaran-cabang-tsn-cetak', $data,true);  
            ...
            case 'beban_cetak':
                ...
                $data['sum'] = $this->aspek_operasional_th_model->getdataindex('aset_investasi_front_sum', 'row_array', 'BEBAN INVESTASI');
                $data['tenaga_kerja'] = $this->aspek_operasional_th_model->getdata('data_beban_tenaga_kerja', 'result_array');
                $data['data_kebijakan_ket_smt1'] = $this->aspek_operasional_th_model->get_ket('ket_kebijakan_alokasi_smt', '1');

                $template  = $this->load->view('tahunan/aspek_operasional/cetak/index-beban-cetak', $data,true);  
                $this->hasil_output('pdf',$mod,'', $data, '', "A4", $template, "ya", "no");
            break;
        }
    ...
    public function save_keterangan(){
        ...
        $this->aspek_operasional_th_model->delete_ket($jns_lap,$iduser);
        $this->aspek_operasional_th_model->insert_ket($data);
    ...
    public function get_file(){
        ...
        $get_db = $this->aspek_operasional_th_model->get_by_id_ket($id);
    ...
    public function nilai_tunai_header(){
        $array = array();    
        $header = $this->aspek_operasional_th_model->getdata('nilai_tunai_header', 'result_array');
        foreach ($header as $k => $v) {
            $judul_total = 'Manfaat Nilai Tunai'; 
            $array[$k]['uraian'] = $judul_total;
            $array[$k]['id'] = $v['id'] ;
            $array[$k]['jml_penerima_thn'] = $v['jml_penerima_thn'] ;
            $array[$k]['jml_pembayaran_thn'] = $v['jml_pembayaran_thn'] ;
            $array[$k]['jml_penerima_thn_lalu'] = $v['jml_penerima_thn_lalu'] ;
    ...
    public function jumlah_pembayaran_cabang(){
        //  Keterangan : variable yang ada '_1'dibelakang itu data tahun sekarang 
        //  Keterangan : variable yang ada '_2'dibelakang itu data tahun Lalu 
        $array = array();    
        $mst_cabang = $this->aspek_operasional_th_model->get_combo('data_cabang', 'result_array', '2');
        foreach ($mst_cabang as $k => $v) {
            ...
            $data_cabang = $this->aspek_operasional_th_model->getdata('pembayaran_pensiun_cabang', 'result_array', $v['id'], '2');
    ...
    public function beban_investasi_semester(){
        ...
        $array = array();
        $invest = $this->aspek_operasional_th_model->getdataindex('aset_investasi_front','result_array', $param_jenis);
        ...
        foreach ($invest as $k => $v) {
            ...
            $array[$k]['persentase'] = ($v['saldo_akhir_thn']!=0)?(($v['saldo_akhir_thn_lalu'] - $v['saldo_akhir_thn'])/$v['saldo_akhir_thn'])*100:0;
            $array[$k]['jns_form'] = $v['jns_form'];
            $array[$k]['child'] = array();
            if($v['type'] == "PC"){
                $childinvest = $this->aspek_operasional_th_model->getdataindex('aset_investasi_front_lv3','result_array', $v['id_investasi'], $param_jenis);
                foreach ($childinvest as $key => $val) {
                    ...
                    $array[$k]['child'][$key]['persentase'] = ($v['saldo_akhir_thn']!=0)?(($v['saldo_akhir_thn_lalu'] - $v['saldo_akhir_thn'])/$v['saldo_akhir_thn'])*100:0;
    ...
    public function nilai_imbal_jasa(){
        $array = array();
        $imbal_jasa = $this->aspek_operasional_th_model->getdata('lkob_imbal_jasa', 'result_array');
        foreach ($imbal_jasa as $k => $v) {
            ...
            $nominal = $v['saldo_akhir_thn_lalu']-$v['saldo_akhir_thn'];
            $persen = ($v['saldo_akhir_thn']!=0)?($nominal/$v['saldo_akhir_thn'])*100:0;

            $array[$k]['id_perubahan_dana_bersih'] = $v['id_perubahan_dana_bersih'];
            $array[$k]['group'] = $judul;
            $array[$k]['saldo_akhir_thn'] = $v['saldo_akhir_thn'];
            $array[$k]['saldo_akhir_thn_lalu'] = $v['saldo_akhir_thn_lalu'];
