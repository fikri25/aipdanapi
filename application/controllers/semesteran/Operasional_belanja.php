...
class Operasional_belanja extends CI_Controller {
	...
	public function index(){
        ...
        $data['view']  = "semesteran/operasional_belanja/index-danabersih";
    ...
    public function Klaim(){
        ...
        $data['semester'] = "";
        $data['klaim_header'] = $this->operasional_belanja_model->getdata('lkob_klaim_header','result_array');
        // $data['klaim_detail'] = $this->operasional_belanja_model->getdata('lkob_klaim_detail','result_array');
        $data['klaim_detail'] = $this->data_klaim_detail();

        $data['data_klaim_ket_smt1'] = $this->operasional_belanja_model->get_ket('ket_lkob_klaim', '1');
        $data['data_klaim_ket_smt2'] = $this->operasional_belanja_model->get_ket('ket_lkob_klaim', '2');
        // echo '<pre>';
        // print_r($data);exit;
        $data['bread'] = array('header'=>'Operasional Belanja', 'subheader'=>'Operasional Belanja');
        $data['view']  = "semesteran/operasional_belanja/index-klaim-header";
        $this->load->view('main/utama', $data);
    }
    ...
    public function pembayaran_pensiun(){
        ...
        $data['opt_smt'] = semester();
        $data['semester'] = "";
        $data['data_kelompok'] = $this->aspek_operasional_model->getdata('pembayaran_pensiun_kelompok', 'result_array','1');
        $data['data_jenis'] = $this->aspek_operasional_model->getdata('pembayaran_pensiun_jenis', 'result_array','1');

        $data['data_pembayaran_pensiun_ket_smt1'] = $this->operasional_belanja_model->get_ket('ket_lkob_pembayaran_pensiun', '1');
        $data['data_pembayaran_pensiun_ket_smt2'] = $this->operasional_belanja_model->get_ket('ket_lkob_pembayaran_pensiun', '2');
        $data['bread'] = array('header'=>'Operasional Belanja', 'subheader'=>'Operasional Belanja');
        $data['view']  = "semesteran/operasional_belanja/index-pembayaran-kelompok";
        $this->load->view('main/utama', $data);
    }
    ...
    public function pembayaran_pensiun_cabang(){
        ...
        $data['data_pembayaran_pensiun_cbg_ket_smt1'] = $this->operasional_belanja_model->get_ket('ket_lkob_pembayaran_pensiun_cbg', '1');
        $data['data_pembayaran_pensiun_cbg_ket_smt2'] = $this->operasional_belanja_model->get_ket('ket_lkob_pembayaran_pensiun_cbg', '2');

        if($this->iduser == "TSN002" || $this->iduser == "DJA001"){
            $data['view']  = "semesteran/operasional_belanja/index-pembayaran-cabang-tsn";
        }else{
            $data['view']  = "semesteran/operasional_belanja/index-pembayaran-cabang-asb";
        }
        // echo '<pre>';
        // print_r($data);exit;
        $this->load->view('main/utama', $data);
    ...
    public function lampiran(){
        ...
        $data['lampiran_lkob'] = $this->operasional_belanja_model->get_ket('ket_lamporan_pendukung_lkob', '1');
        // print_r($data);exit;
        $data['bread'] = array('header'=>'Operasional Belanja', 'subheader'=>'Operasional Belanja');
        $data['view']  = "semesteran/operasional_belanja/index-lampiran-pendukung";
        $this->load->view('main/utama', $data);
    }
    ...
    function get_form($mod){
        ...
        switch($mod){
            ...
            case 'lkob_klaim':
                ...
                $data['bread'] = array('header'=>'Operasional Belanja', 'subheader'=>'Operasional Belanja');
                $data['view']  = "semesteran/operasional_belanja/input-klaim";
            ...
            case 'pembayaran_pensiun_apbn':
                ...
                $data['view']  = "semesteran/operasional_belanja/input-pembayaran-aip";
            ...
            case 'pembayaran_pensiun_apbn_cabang':
                ...
                $data['bread'] = array('header'=>'Aspek Operasional', 'subheader'=>'Aspek Operasional');
                $data['view']  = "semesteran/operasional_belanja/input-pembayaran-aip-cabang";
    ...
    function cetak($mod=""){
        ...
        switch($mod){
            case 'pembayaran_pensiun_apbn_cetak':
                ...
                $data['data_kelompok'] = $this->aspek_operasional_model->getdata('pembayaran_pensiun_kelompok', 'result_array','1');
                $data['data_jenis'] = $this->aspek_operasional_model->getdata('pembayaran_pensiun_jenis', 'result_array','1');
                $template  = $this->load->view('semesteran/operasional_belanja/cetak/index-pembayaran-aip-cetak', $data,true);  
            ...
            case 'pembayaran_pensiun_apbn_cabang_cetak':
                ...
                if($data['iduser'] == ""){
                    if($this->iduser == "TSN002"){
                        $template  = $this->load->view('semesteran/operasional_belanja/cetak/index-pembayaran-cabang-tsn-cetak', $data,true);  
                    }else if ($this->iduser == "ASB003") {
                        $template  = $this->load->view('semesteran/operasional_belanja/cetak/index-pembayaran-cabang-asb-cetak', $data,true); 
                    }
                }else{
                    if($data['iduser'] == "TSN002"){
                        $template  = $this->load->view('semesteran/operasional_belanja/cetak/index-pembayaran-cabang-tsn-cetak', $data,true);  
            ...
            case 'klaim_cetak':
                ...
                $data['klaim_header'] = $this->operasional_belanja_model->getdata('lkob_klaim_header','result_array');
                $data['klaim_detail'] = $this->data_klaim_detail();
                $template  = $this->load->view('semesteran/operasional_belanja/cetak/index-klaim-cetak', $data,true);  
    ...
    public function get_file(){
        ...
        $get_db = $this->operasional_belanja_model->get_by_id_ket($id);
    ...
    public function get_file_klaim(){
        $id = $this->uri->segment(4);
        $get_db = $this->operasional_belanja_model->get_by_id_klaim($id);
        $file = $get_db[0]['filedata'];
        $path = './files/file_semesteran/operasional_belanja/'.$file;
        $data = file_get_contents($path);
        $name = $file;
        force_download($name,$data);
    } 
    ...
    public function jumlah_pembayaran_cabang(){
        $array = array();    
        $mst_cabang = $this->aspek_operasional_model->get_combo('data_cabang', 'result_array', '1');
        foreach ($mst_cabang as $k => $v) {
            ...
            $data_cabang = $this->aspek_operasional_model->getdata('pembayaran_pensiun_cabang', 'result_array', $v['id'], '1');
    ...
    public function data_klaim_detail($value=''){        
        $array = array();
        $klaim_detail = $this->operasional_belanja_model->getdata('lkob_klaim_detail', 'result_array');
        foreach ($klaim_detail as $k => $v) {

            $array[$k]['nama_cabang'] = $v['nama_cabang'] ;
            $array[$k]['jenis_klaim'] = $v['jenis_klaim'] ;
            $array[$k]['jml_klaim_smt1'] = $v['jml_klaim_smt1'] ;
            $array[$k]['jml_pembayaran_smt1'] = $v['jml_pembayaran_smt1'] ;
            $array[$k]['jml_klaim_smt2'] = $v['jml_klaim_smt2'] ;
            $array[$k]['jml_pembayaran_smt2'] = $v['jml_pembayaran_smt2'] ;

            $jml_klaim_min = $v['jml_klaim_smt2'] - $v['jml_klaim_smt1'];
            $jml_pembayaran_min = $v['jml_pembayaran_smt2'] - $v['jml_pembayaran_smt1'];

            $array[$k]['pers_kenaikan_penerima'] = ($v['jml_klaim_smt1']!=0)?($jml_klaim_min/$v['jml_klaim_smt1'])*100:0;
            $array[$k]['pers_kenaikan_pembayaran'] = ($v['jml_klaim_smt1']!=0)?($jml_pembayaran_min/$v['jml_pembayaran_smt1'])*100:0;
        }
