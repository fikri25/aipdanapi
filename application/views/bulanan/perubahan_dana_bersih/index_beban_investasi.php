                        ...
                        <div class="box-body" style="overflow-x:auto;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group adm">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensearch('index-beban-investasi','index-beban-investasi');">
                                    ...
                                    <div  class="col-md-8"> 
                                        <div class="form-group pull-right">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat user-bln" onClick="genform('add', 'beban_investasi','beban_investasi');">
                                                <i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah
                                            </a>  
                                            &nbsp;&nbsp;
                                            <a href="#" data-target="#Modal_ket" data-toggle="modal" class="btn btn-sm btn-warning btn-flat user-bln" title="Keterangan"><i class="fa fa-info-circle"></i> Keterangan
                                            </a>
                                            &nbsp;&nbsp;
                                            <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genform('print-all', 'beban_investasi_cetak','beban_investasi_cetak');">
                            ...
                            <table id="tbl-invest-smt" class="table table-bordered table-striped table-hover tbl-form">
                                    ...
                                    <?php foreach($data_beban as $beban):?>
                                        <?php if($beban['type'] == 'P'):?>
                                            <tr class="cek">
                                                ...
                                                <td><?=($beban['saldo_awal'] != 0 ) ? rupiah($beban['saldo_awal']) : '-';?></td>
                                                <td><?=($beban['saldo_akhir'] != 0 ) ? rupiah($beban['saldo_akhir']) : '-';?></td>
                                ...
                                <tfoot style="background-color: #d8d8d8; font-weight: bold;">
                                    ...
                                    <td><?=($sum['nominal'] != 0 ) ? rupiah($sum['nominal']) : '-';?></td>
                                    <td><?=($sum['persentase'] != 0 ) ? persen($sum['persentase']).'%' : '-';?></td>
                                    <td><?=($sum['rka'] != 0 ) ? rupiah($sum['rka']) : '-';?></td>
                                    <td><?=($sum['pers_rka'] != 0 ) ? persen($sum['pers_rka']).'%' : '-';?></td>
                                </tfoot>
                            </table>
                            <br>
                            <!-- data keterangan  -->
                            <div style="padding:4px;">
                                ...
                                <div style="padding:4px;border-style:groove;border-color:lightblue;">
                                    <p style="margin-left:10px;font-size: 14px;margin-right: 15px;margin-left: 15px;text-align: justify;"><?php echo (isset($data_beban_investasi_ket[0]->keterangan_lap) ? $data_beban_investasi_ket[0]->keterangan_lap : '');?></p>

                                    <p style="margin-left:15px;font-size: 14px;font-weight: bold">Dokumen : 
                                    <a href="<?php echo site_url('bulanan/perubahan_dana_bersih/get_file/'.(isset($data_beban_investasi_ket[0]->id) ? $data_beban_investasi_ket[0]->id : ''));?>"><?php echo (isset($data_beban_investasi_ket[0]->file_lap) ? $data_beban_investasi_ket[0]->file_lap : '');?></a>
                                    </p>
...
<div class="modal fade" id="Modal_ket" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'bulanan/perubahan_dana_bersih/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="jns_lap" value="ket_beban_investasi">
                <input type="hidden" name="nmdok" value="Beban_Investasi">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_beban_investasi_ket[0]->keterangan_lap) ? $data_beban_investasi_ket[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_beban_investasi_ket[0]->id) ? $data_beban_investasi_ket[0]->id : '');?>">
                    <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_beban_investasi_ket[0]->file_lap) ? $data_beban_investasi_ket[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('bulanan/perubahan_dana_bersih/get_file/'.(isset($data_beban_investasi_ket[0]->id) ? $data_beban_investasi_ket[0]->id : ''));?>"><p><?php echo (isset($data_beban_investasi_ket[0]->file_lap) ? $data_beban_investasi_ket[0]->file_lap : '');?></p></a>
                  </div>
                </div>
