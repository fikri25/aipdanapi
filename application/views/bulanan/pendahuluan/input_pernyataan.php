      ...
      <div class="nav-tabs-custom">
        ...
        <div class="box box-default">
          ...
          <div class="row" style="margin-left: 50px">
            ...
            <div class="col-md-1">
              <div class="form-group adm">
                <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensearch('index-pernyataan','index-pernyataan');">
              ...
              <div class="col-md-12">
                <div style="margin-left: 50px;margin-right: 50px">
                  <p style="font-weight: bold">
                    ...
                    <h4 align="center">TENTANG TANGGUNG JAWAB ATAS LAPORAN BULANAN</h4>
                    ...
                    <?php endif;?>
                    <h4 align="center" style="text-transform: uppercase;">BULAN <?php echo $bulan[0]->nama_bulan; ?>&nbsp;TAHUN&nbsp;<?php echo $tahun; ?></h4>
                  </p>
                  <hr style="height:3px;background-color:#a8a8a8;">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url('bulanan/pendahuluan/update_status');?>">
                    ...
                    <?php if($iduser == 'TSN002'):?>
                      <p>1. Bertanggung jawab atas penyusunan dan penyajian laporan bulanan pengelolaan akumulasi iuran pensiun Pegawai Negeri Sipil dan Pejabat Negara;</p>
                    ...
                    <?php endif;?>
                    <?php if($iduser == 'ASB003'):?>
                      <p>1. Bertanggung jawab atas penyusunan dan penyajian laporan bulanan pengelolaan akumulasi iuran pensiun TNI/POLRI;</p>
                      <p>2. Laporan keuangan laporan bulanan pengelolaan akumulasi iuran pensiun TNI/POLRI telah disusun dan disajikan sesuai dengan ketentuan yang berlaku; </p>
                      <p>3. Semua informasi dalam laporan-laporan bulanan pengelolaan akumulasi iuran pensiun TNI/POLRI telah dimuat secara lengkap dan benar.</p>
                      <p>Demikian peryataan ini dibuat dengan sebenarnya.</p><br><br>
                    <?php endif;?>
                ...
                <div class="col-sm-12">
                  <?php if($level != "DJA"){?>
                    <a href="<?php echo site_url('#').get_uri();?>" data-target="#modal" data-toggle="modal" class="btn btn-success btn-flat <?php if (isset($data_pendahuluan[0]->status) == "Selesai"){echo 'disabled';}?>" style="margin-right: 0px"><i class="fa fa-check"></i>&nbsp;&nbsp;Simpan</a>
                     ...
                     <?php if (isset($data_pendahuluan[0]->status) != NULL){?>
                      <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genform('print-all', 'cetak_bukti','cetak_bukti');">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="modal-title" style="text-align:center;font-size:15px;">Apakah anda yakin ingin menyelesaikan laporan bulanan ?</p>
            <div class="row">
              <div class="col-md-12">
