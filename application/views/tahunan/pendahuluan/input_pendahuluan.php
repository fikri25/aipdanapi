          ...
          <div class="box-body">
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-1">
                  <div class="form-group adm">
                    <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gentahunansearch('index-pendahuluan-tahunan','index-pendahuluan-tahunan');">
                ...
                <div  class="col-md-8"> 
                  <div class="form-group pull-right">
                    <!-- <a href="<?php echo site_url('tahunan/pendahuluan/laporan_Pendahuluan_PDF');?>" target="blank" class="btn btn-sm btn-danger btn-flat pull-right"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Export PDF</a> -->
                    <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformtahunan('print-all', 'index-pendahuluan-thn-cetak','index-pendahuluan-thn-cetak');">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url('tahunan/pendahuluan/save_pendahuluan');?>">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12" style="background-color: #dae7ef;">
                    <div class="form-group" style="margin-left: 20px;">
                      ...
                      <input type="hidden" name="nmdok" value="Pendahuluan_Tahun">
