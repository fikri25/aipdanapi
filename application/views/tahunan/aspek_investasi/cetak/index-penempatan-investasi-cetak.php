...
<table cellpadding="4px" cellspacing="0px" border="1" autosize="1" style="color:#000;background:#fff;font-size: 12px;">
  <thead>
    <tr>
      ...
      <th rowspan="2">Capaian Tahun <?= $tahun - 1; ?> terhadap RKAP</th>
    ...
    <?php foreach($data_invest as $invest):?>
      <?php if($invest['type'] == 'P'):?>
        <tr>
          ...
          <td style="text-align: right;"><?=($invest['saldo_akhir_thn'] != 0 ) ? rupiah($invest['saldo_akhir_thn']) : '-';?></td>
          ...
          <td style="text-align: right;"><?=($invest['saldo_akhir_thn_lalu'] != 0 ) ? rupiah($invest['saldo_akhir_thn_lalu']) : '-';?></td>
