							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="rka_penerima" class="form-control rka_penerima" id="rka_penerima" value="<?= !empty($data) ? $data['rka_penerima'] : '';?>" placeholder="Penerima"/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
														...
														<?php if(isset($data_detail) && is_array($data_detail)):?>
															...
															<?php foreach($data_detail as  $detail):?>
																<tr class="tr_inv_" id="tr_inv_<?=$idx;?>" idx="<?=$idx;?>">
																	...
																	<td>
																		<input type="text" name="jml_penerima[]" class="form-control jml_penerima_1" id="jml_penerima_<?=$idx;?>" idx="<?=$idx;?>" value="<?= $detail['jml_penerima'];?>" style="width:100%"/>		
																	</td>
																	<td>
