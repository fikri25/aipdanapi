...
<form id="form_<?=$acak;?>" method="post" url="<?php echo site_url(); ?>aspek-operasional-simpan/pembayaran_aip_cabang" enctype="multipart/form-data" >
	...
	<input type="hidden" name="sumber_dana" value="2">

	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Form Pembayaran Pensiun AIP (Cabang)</h3>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<a href="<?php echo site_url('semesteran/aspek_operasional/pembayaran_pensiun_aip');?>" class="btn btn-danger btn-flat"></i>&nbsp;&nbsp;Kembali</a>
								</div>
							</div>
