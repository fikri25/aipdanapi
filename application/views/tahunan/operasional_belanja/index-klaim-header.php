 			...
 			<div class="box box-default">
              ...
              <div  class="col-md-8"> 
                <div class="form-group pull-right">
                  ...
                  &nbsp;&nbsp;
                  <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformtahunan('print-all', 'klaim_cetak','klaim_cetak');">
                ...
                <tbody>
                 ...
                 <?php foreach($klaim_header as $header):?>
                    <tr>
                      ...
                      <td><?=($header['jml_klaim_thn'] != 0 ) ? rupiah($header['jml_klaim_thn']) : '-';?></td>
                      <td><?=($header['jml_pembayaran_thn'] != 0 ) ? rupiah($header['jml_pembayaran_thn']) : '-';?></td>
                      <td><?=($header['jml_klaim_thn_lalu'] != 0 ) ? rupiah($header['jml_klaim_thn_lalu']) : '-';?></td>
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'tahunan/operasional_belanja/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="nmdok" value="Lkob_Klaim_Tahun">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="data_klaim_ket_thn" rows="10"><?php echo (isset($data_klaim_ket_thn[0]->keterangan_lap) ? $data_klaim_ket_thn[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_klaim_ket_thn[0]->id) ? $data_klaim_ket_thn[0]->id : '');?>">
                    <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_klaim_ket_thn[0]->file_lap) ? $data_klaim_ket_thn[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('tahunan/operasional_belanja/get_file/'.(isset($data_klaim_ket_thn[0]->id) ? $data_klaim_ket_thn[0]->id : ''));?>"><p><?php echo (isset($data_klaim_ket_thn[0]->file_lap) ? $data_klaim_ket_thn[0]->file_lap : '');?></p></a>
                  </div>
                </div>
