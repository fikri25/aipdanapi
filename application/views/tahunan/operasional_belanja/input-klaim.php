							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="form-control select2nya jenis_klaim" name="jenis_klaim" id="jenis_klaim">
											<option value="">
												-- Pilih --
											</option>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="rka_jml_klaim" class="form-control rka_jml_klaim" id="rka_jml_klaim" value="<?= !empty($data) ? $data['rka_jml_klaim'] : '';?>" placeholder="Klaim"/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
														...
														<?php if(isset($data_detail) && is_array($data_detail)):?>
															...
															<?php foreach($data_detail as  $detail):?>
																<tr class="tr_inv_" id="tr_inv_<?=$idx;?>" idx="<?=$idx;?>">
																	...
																	<td>
																		<input type="text" name="jml_klaim[]" class="form-control jml_klaim_1" id="jml_klaim_<?=$idx;?>" idx="<?=$idx;?>" value="<?= $detail['jml_klaim'];?>" style="width:100%"/>		
																	</td>
																	<td>
