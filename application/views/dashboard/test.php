        ...
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Dana Bersih 1</h3>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Detail Data 1</h3>
                </div>
                <div class="box-body" style="overflow-x:auto;">
                    <table id="example" class="table table-responsive table-bordered table-hover">
                        ...
                        <?php foreach($data as $date => $userData): 
                            ...
                            ?>
                            <tr style="<?php if ($userData['uraian'] == 'DANA BERSIH'){echo 'font-weight: bold; background-color: #ddd;';}?>">
