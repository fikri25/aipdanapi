                ...
                <div class="box-body" style="overflow-x:auto;">
                    <table id="example" class="table table-responsive table-bordered table-hover">
                        ...
                        <?php foreach($data as $date => $userData): 
                            ...
                            ?>
                            <tr style="<?php if ($userData['id_aruskas'] == '00'){echo 'font-weight: bold; background-color: #ddd;';}?>">
...
<script type="text/javascript">
    ...
    $.post(host+'dashboard-display/summary_aruskas_head', {[csrf_token]:csrf_hash, 'id_bulan':id_bulan, 'iduser':iduser,'bln_awal':bln_awal,'bln_akhir':bln_akhir,'tahun_awal':tahun_awal,'tahun_akhir':tahun_akhir}, function(resp){
        if(resp){
