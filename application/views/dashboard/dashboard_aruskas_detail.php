        ...
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Arus Kas - Detail</h3>
                </div>
                ...
                <div class="box-body" style="overflow-x:auto;">
                    <table id="example" class="table table-responsive table-bordered table-hover">
                        ...
                        <?php foreach($data as $date => $userData): 
                            ...
                            ?>
                            <tr style="<?php if ($userData['jenis_kas'] == 'JUMLAH'){echo 'font-weight: bold; background-color: #ddd;';}?>">
...
<script type="text/javascript">
    ...
    $.post(host+'dashboard-display/summary_aruskas_detail', {[csrf_token]:csrf_hash, 'id_bulan':id_bulan, 'iduser':iduser,'bln_awal':bln_awal,'bln_akhir':bln_akhir,'jns_lap':jns_lap,'tahun_awal':tahun_awal,'tahun_akhir':tahun_akhir}, function(resp){
        if(resp){
