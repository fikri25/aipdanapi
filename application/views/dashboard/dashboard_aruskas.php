        ...
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Jenis Aktivitas Aruskas</label>
                  <select class="form-control select2nya" id="jns_lap">
                    <option value="">
                      --Pilih--
                    </option>
                    <?php if(isset($opt_aruskas) && is_array($opt_aruskas)){?> 
                      <?php foreach($opt_aruskas as $k=>$v){?>
                        <option value="<?php echo $v['id'];?>" <?php if(!empty($iduser) && $v['id'] == $iduser) echo 'selected="selected"';?>>
                          <?php echo $v['txt'];?>
                        </option>
                      <?php }?>
            ...
            <div class="row">
              ...
              <div class="col-md-1">
                <div class="form-group">
                  <br>
                  <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat tombol_cari" onClick="gendashboardsearch('index-dashboard-aruskas','index-dashboard-aruskas');">
...
<div class="content-dashboard">
 <?php $this->load->view('dashboard/dashboard_aruskas_head'); ?>
</div>
