 	...
 	<div class="col-xs-12">
 		<div class="nav-tabs-custom">
 			...
 			<div class="box box-default">
              ...
              <div class="col-md-1">
               <div class="form-group">
                <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-klaim','index-klaim');">
          ...
          <div  class="col-md-4"> 
            <div class="form-group dropdown pull-right user">
              ...
              <div class="form-group pull-right">
                <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat user user-smt2" onClick="genformsemester('add', 'lkob_klaim','lkob_klaim');">
                  <i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah
                </a>      
                &nbsp;&nbsp;
                <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'klaim_cetak','klaim_cetak');">
        ...
        <div id="contentpane" class="layout layout-center scroll" style="padding:10px;">
         <div class="panel panel-default">    
          ...
          <ul class="nav nav-tabs" role="tablist">
           <li class="active"><a href="#tab_list_data_aset_temuan" role="tab" data-toggle="tab"><strong>Klaim Header</strong></a></li>
           <li><a href="#tab_tambah_data" role="tab" data-toggle="tab"><strong>Klaim Detail</strong></a></li>
         </ul>
               ...
               <table id="tbl-cabang-2" class="table table-responsive table-bordered table-hover">
                <thead>
                 <tr>
                  ...
                  <th class="user" rowspan="2" width="13%">Action</th>
                </tr>
                <tr>
                  <th>Jumlah Klaim</th>
              ...
              <tbody>
               ...
               <?php foreach($klaim_header as $header):?>
                <tr>
                  ...
                  <td><?=($header['jml_klaim_smt1'] != 0 ) ? rupiah($header['jml_klaim_smt1']) : '-';?></td>
                  <td><?=($header['jml_pembayaran_smt1'] != 0 ) ? rupiah($header['jml_pembayaran_smt1']) : '-';?></td>
                  <td><?=($header['jml_klaim_smt2'] != 0 ) ? rupiah($header['jml_klaim_smt2']) : '-';?></td>
                  <td><?=($header['jml_pembayaran_smt2'] != 0 ) ? rupiah($header['jml_pembayaran_smt2']) : '-';?></td>
                  <td><?=persen($header['pers_penerimaan']);?>%</td>
                  <td><?=persen($header['pers_pembayaran']);?>%</td>
                  <td><?=rupiah($header['rka_jml_klaim']);?></td>
                  <td><?=rupiah($header['rka_jml_pembayaran']);?></td>
                  ...
                  <td class="user">
                    <div class="dropdown pull-right">
                      <button class="btn btn-danger btn-flat dropdown-toggle" title="Delete" type="button" data-toggle="dropdown"><i class="fa fa-trash"></i>
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <a href="javascript:void(0)" class="user-smt1" title="Delete" onClick="genformsemester('delete', 'lkob_klaim','lkob_klaim','','<?=$header['id']?>','1');">Semester I</a>
                          </li>
                          <?php if($header['id_smt2'] != ""):?>
                            <li>
                              <a href="javascript:void(0)" class="user-smt2" title="Delete" onClick="genformsemester('delete', 'lkob_klaim','lkob_klaim','','<?=$header['id'] ?>','2');">Semester II</a>
                            </li>
                          <?php endif;?>
                        </ul>
                      </div>
                      <div class="dropdown pull-right">
                        <button class="btn btn-success btn-flat dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-edit"></i>
                          <span class="caret"></span></button>
                          <ul class="dropdown-menu">
                            <li>
                              <a href="javascript:void(0)" class="user-smt1" title="Edit" onClick="genformsemester('edit', 'lkob_klaim','lkob_klaim','','<?=$header['kode_klaim']?>','1');">Semester I</a>
                            </li>
                            <?php if($header['id_smt2'] != ""):?>
                              <li>
                                <a href="javascript:void(0)" class="user-smt2" title="Edit" onClick="genformsemester('edit', 'lkob_klaim','lkob_klaim','','<?=$header['kode_klaim'] ?>','2');">Semester II</a>
                              </li>
                            <?php endif;?>
                          </ul>
                        </div> 
       ...
       <div class="tab-pane fade in" id="tab_tambah_data" style="overflow-x:auto;">
        <?php include 'index-klaim-detail.php' ;?>
      </div>
      <!-- Modal input/edit -->
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/operasional_belanja/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="jns_lap" value="ket_lkob_klaim">
                <input type="hidden" name="nmdok" value="Lkob_Klaim_Semester">
                <input type="hidden" name="semester" value="1">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_klaim_ket_smt1[0]->keterangan_lap) ? $data_klaim_ket_smt1[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_klaim_ket_smt1[0]->id) ? $data_klaim_ket_smt1[0]->id : '');?>">
                    <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_klaim_ket_smt1[0]->file_lap) ? $data_klaim_ket_smt1[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/operasional_belanja/get_file/'.(isset($data_klaim_ket_smt1[0]->id) ? $data_klaim_ket_smt1[0]->id : ''));?>"><p><?php echo (isset($data_klaim_ket_smt1[0]->file_lap) ? $data_klaim_ket_smt1[0]->file_lap : '');?></p></a>
                  </div>
                </div>
            ...
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/operasional_belanja/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_klaim_ket_smt2[0]->keterangan_lap) ? $data_klaim_ket_smt2[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_klaim_ket_smt2[0]->id) ? $data_klaim_ket_smt2[0]->id : '');?>">
                    <input type="hidden" name="filedata" value="<?php echo (isset($data_klaim_ket_smt2[0]->file_lap) ? $data_klaim_ket_smt2[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/operasional_belanja/get_file/'.(isset($data_klaim_ket_smt2[0]->id) ? $data_klaim_ket_smt2[0]->id : ''));?>"><p><?php echo (isset($data_klaim_ket_smt2[0]->file_lap) ? $data_klaim_ket_smt2[0]->file_lap : '');?></p></a>
                  </div>
                </div>
                <div class="modal-footer with-border">
                  <div class="col-sm-12">
