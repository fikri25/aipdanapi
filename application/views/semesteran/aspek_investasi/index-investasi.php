                        ...
                        <div class="box-body" style="overflow-x:auto;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-penempatan-investasi','index-penempatan-investasi');">
                                    ...
                                    <div  class="col-md-4"> 
                                        ...
                                        <div class="form-group pull-right">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'penempatan_investasi_cetak','penempatan_investasi_cetak');">
                                    ...
                                    <?php foreach($data_invest as $invest):?>
                                        <?php if($invest['type'] == 'P'):?>
                                            <tr>
                                                ...
                                                <td><?=($invest['saldo_akhir_smt1'] != 0 ) ? rupiah($invest['saldo_akhir_smt1']) : '-';?></td>
                                                <td><?=($invest['mutasi_penambahan'] != 0 ) ? rupiah($invest['mutasi_penambahan']) : '-';?></td>
                                                <td><?=($invest['mutasi_pengurangan'] != 0 ) ? rupiah($invest['mutasi_pengurangan']) : '-';?></td>
                                                <td><?=($invest['saldo_akhir_smt2'] != 0 ) ? rupiah($invest['saldo_akhir_smt2']) : '-';?></td>
                                                <td><?=($invest['rka'] != 0 ) ? rupiah($invest['rka']) : '-';?></td>
                                                <td><?=($invest['pers_rka'] != 0 ) ? persen($invest['pers_rka']).'%' : '-';?></td>
                                                <td><?=($invest['nominal'] != 0 ) ? rupiah($invest['nominal']) : '-';?></td>
                                                <td><?=($invest['persentase'] != 0 ) ? persen($invest['persentase']).'%' : '-';?></td>
                            ...
                            <div style="padding:4px;">
                                ...
                                <div style="padding:4px;border-style:groove;border-color:lightblue;">
                                    <p style="margin-left:10px;font-size: 14px;margin-right: 15px;margin-left: 15px;text-align: justify;"><?php echo (isset($data_penempatan_investasi_ket_smt1[0]->keterangan_lap) ? $data_penempatan_investasi_ket_smt1[0]->keterangan_lap : '');?></p>

                                    <p style="margin-left:15px;font-size: 14px;font-weight: bold">Dokumen Semester I : 
                                    <a href="<?php echo site_url('semesteran/aspek_investasi/get_file/'.(isset($data_penempatan_investasi_ket_smt1[0]->id) ? $data_penempatan_investasi_ket_smt1[0]->id : ''));?>"><?php echo (isset($data_penempatan_investasi_ket_smt1[0]->file_lap) ? $data_penempatan_investasi_ket_smt1[0]->file_lap : '');?></a>
                                    </p>
                                    <br>
                                    <?php if(isset($data_penempatan_investasi_ket_smt2[0]->id) != "") :?>
                                    <p style="margin-left:10px;font-size: 14px;margin-right: 15px;margin-left: 15px;text-align: justify;"><?php echo (isset($data_penempatan_investasi_ket_smt2[0]->keterangan_lap) ? $data_penempatan_investasi_ket_smt2[0]->keterangan_lap : '');?></p>

                                    <p style="margin-left:15px;font-size: 14px;font-weight: bold">Dokumen Semester II : 
                                      <a href="<?php echo site_url('semesteran/aspek_investasi/get_file/'.(isset($data_penempatan_investasi_ket_smt2[0]->id) ? $data_penempatan_investasi_ket_smt2[0]->id : ''));?>"><?php echo (isset($data_penempatan_investasi_ket_smt2[0]->file_lap) ? $data_penempatan_investasi_ket_smt2[0]->file_lap : '');?></a>
                                    </p>
                                    <?php endif; ?>
                                </div>
                            </div>
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_investasi/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="jns_lap" value="ket_lkai_penempatan_investasi">
                <input type="hidden" name="nmdok" value="Penempatan_Investasi_Semester">
                <input type="hidden" name="semester" value="1">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_penempatan_investasi_ket_smt1[0]->keterangan_lap) ? $data_penempatan_investasi_ket_smt1[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_penempatan_investasi_ket_smt1[0]->id) ? $data_penempatan_investasi_ket_smt1[0]->id : '');?>">
                    <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_penempatan_investasi_ket_smt1[0]->file_lap) ? $data_penempatan_investasi_ket_smt1[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/aspek_investasi/get_file/'.(isset($data_penempatan_investasi_ket_smt1[0]->id) ? $data_penempatan_investasi_ket_smt1[0]->id : ''));?>"><p><?php echo (isset($data_penempatan_investasi_ket_smt1[0]->file_lap) ? $data_penempatan_investasi_ket_smt1[0]->file_lap : '');?></p></a>
                  </div>
                </div>
            ...
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_investasi/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_penempatan_investasi_ket_smt2[0]->keterangan_lap) ? $data_penempatan_investasi_ket_smt2[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_penempatan_investasi_ket_smt2[0]->id) ? $data_penempatan_investasi_ket_smt2[0]->id : '');?>">
                    <input type="hidden" name="filedata" value="<?php echo (isset($data_penempatan_investasi_ket_smt2[0]->file_lap) ? $data_penempatan_investasi_ket_smt2[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/aspek_investasi/get_file/'.(isset($data_penempatan_investasi_ket_smt2[0]->id) ? $data_penempatan_investasi_ket_smt2[0]->id : ''));?>"><p><?php echo (isset($data_penempatan_investasi_ket_smt2[0]->file_lap) ? $data_penempatan_investasi_ket_smt2[0]->file_lap : '');?></p></a>
                  </div>
                </div>
                <div class="modal-footer with-border">
                  <div class="col-sm-12">
