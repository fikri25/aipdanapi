 		...
 		<div class="nav-tabs-custom">
 			...
 			<div class="box box-default">
 				<div class="box-header with-border">
 					<h3 class="box-title">Pembayaran Pensiun AIP</h3>
 					...
 					<div class="col-md-12">
 						<div class="row">
                            ...
                            <div class="col-md-3">
 							...
 							<div class="col-md-1">
 								<div class="form-group">
 									<a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-pembayaran-kelompok','index-pembayaran-kelompok');">
                            ...
                            <div  class="col-md-5"> 
                                ...
                                <div class="form-group pull-right">
                                    <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat user user-smt2" onClick="genformsemester('add', 'pembayaran_aip','pembayaran_aip');">
                                        <i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah
                                    </a>  
                                    &nbsp;&nbsp;
                                    <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat user user-smt2" onClick="genformsemester('add', 'pembayaran_pensiun_aip_cabang','pembayaran_pensiun_aip_cabang');">
                                        <i class="fa fa-plus"></i>&nbsp;&nbsp;Data Cabang
                                    </a>  
                                    &nbsp;&nbsp;

                                    <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'pembayaran_pensiun_aip_cetak','pembayaran_pensiun_aip_cetak');"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak PDF
                                    </a>  
                                    &nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
 								...
 								<div class="tab-pane fade in active" id="tab_list_data_aset_temuan" style="margin-bottom: 100px;">
 									...
 									<div class="table-responsive">
                                        ...
                                        <?php if($semester == 2 || $semester == ""):?>
 										<table id="tbl-kelompok-2" class="table table-responsive table-bordered table-hover" width="100%">
 											<thead>
 												<tr>
 													<th rowspan="2">No</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="user">
                                                                ...
                                                                <div class="dropdown pull-right">
                                                                    <button class="btn btn-sm btn-primary btn-flat dropdown-toggle" type="button" data-toggle="dropdown" title="Edit"><i class="fa fa-edit"></i> Pensiun AIP
                                                                    <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt1" title="Edit" onClick="genformsemester('edit', 'pembayaran_aip','pembayaran_aip','','<?=$kelompok['id_kelompok']?>','1');">Semester I</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt2" title="Edit" onClick="genformsemester('edit', 'pembayaran_aip','pembayaran_aip','','<?=$kelompok['id_kelompok'] ?>','2');">Semester II</a>
                                                                        </li>
                                                                     </ul>
                                                                </div> 
                                                                <?php endif;?>
                                                                ...
                                                                <div class="dropdown pull-right">
                                                                    <button class="btn btn-sm btn-success btn-flat dropdown-toggle" type="button" data-toggle="dropdown" title="Edit"><i class="fa fa-edit"></i> Cabang AIP
                                                                    <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt1" title="Edit" onClick="genformsemester('edit', 'pembayaran_pensiun_aip_cabang','pembayaran_pensiun_aip_cabang','','<?=$kelompok['id_kelompok']?>','1');">Semester I</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt2" title="Edit" onClick="genformsemester('edit', 'pembayaran_pensiun_aip_cabang','pembayaran_pensiun_aip_cabang','','<?=$kelompok['id_kelompok'] ?>','2');">Semester II</a>
                                                                        </li>
                                                                     </ul>
                                                                </div> 
                                                                <?php endif;?>
                                                            ...
                                                            <td class="user">
                                                                ...
                                                                <div class="dropdown pull-right">
                                                                    <button class="btn btn-sm btn-danger btn-flat dropdown-toggle" type="button" data-toggle="dropdown" title="Hapus"><i class="fa fa-trash"></i> Pensiun AIP
                                                                    <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt1" title="delete" onClick="genformsemester('delete', 'pembayaran_aip','pembayaran_aip','','<?=$kelompok['id_kelompok']?>','1','2');">Semester I</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt2" title="delete" onClick="genformsemester('delete', 'pembayaran_aip','pembayaran_aip','','<?=$kelompok['id_kelompok'] ?>','2','2');">Semester II</a>
                                                                        </li>
                                                                     </ul>
                                                                </div> 
                                                                <?php endif;?> 
                                                                ...
                                                                <?php if($kelompok['id_smt1'] != "" || $kelompok['id_smt2'] != ""):?>
                                                                <div class="dropdown pull-right">
                                                                    <button class="btn btn-sm btn-danger btn-flat dropdown-toggle" type="button" data-toggle="dropdown" title="Hapus"><i class="fa fa-trash"></i> Cabang AIP
                                                                    <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt1" title="delete" onClick="genformsemester('delete', 'pembayaran_pensiun_aip_cabang','pembayaran_pensiun_aip_cabang','','<?=$kelompok['id_kelompok']?>','1','2');">Semester I</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="user-smt2" title="delete" onClick="genformsemester('delete', 'pembayaran_pensiun_aip_cabang','pembayaran_pensiun_aip_cabang','','<?=$kelompok['id_kelompok'] ?>','2','2');">Semester II</a>
                                                                        </li>
                                                                     </ul>
                                                                </div>
                                                                <?php endif;?> 
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-group-sm">
                                    <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_operasional/save_keterangan'?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="jns_lap" value="ket_lkao_pembayaran_pensiun_aip">
                                        <input type="hidden" name="nmdok" value="Pembayaran_Pensiun_AIP_Semester">
                                        <input type="hidden" name="semester" value="1">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                                            <div class="col-sm-10">
                                                <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_pembayaran_pensiun_aip_ket_smt1[0]->keterangan_lap) ? $data_pembayaran_pensiun_aip_ket_smt1[0]->keterangan_lap : '');?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                                            <div class="col-sm-10">
                                                <input type="hidden" name="id" value="<?php echo (isset($data_pembayaran_pensiun_aip_ket_smt1[0]->id) ? $data_pembayaran_pensiun_aip_ket_smt1[0]->id : '');?>">
                                                <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_pembayaran_pensiun_aip_ket_smt1[0]->file_lap) ? $data_pembayaran_pensiun_aip_ket_smt1[0]->file_lap : '');?>">
                                                <input type="file" name="filedata">
                                                <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                                                <a href="<?php echo site_url('semesteran/aspek_operasional/get_file/'.(isset($data_pembayaran_pensiun_aip_ket_smt1[0]->id) ? $data_pembayaran_pensiun_aip_ket_smt1[0]->id : ''));?>"><p><?php echo (isset($data_pembayaran_pensiun_aip_ket_smt1[0]->file_lap) ? $data_pembayaran_pensiun_aip_ket_smt1[0]->file_lap : '');?></p></a>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group form-group-sm">
                                    <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_operasional/save_keterangan'?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                                            <div class="col-sm-10">
                                                <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_pembayaran_pensiun_aip_ket_smt2[0]->keterangan_lap) ? $data_pembayaran_pensiun_aip_ket_smt2[0]->keterangan_lap : '');?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                                            <div class="col-sm-10">
                                                <input type="hidden" name="id" value="<?php echo (isset($data_pembayaran_pensiun_aip_ket_smt2[0]->id) ? $data_pembayaran_pensiun_aip_ket_smt2[0]->id : '');?>">
                                                <input type="hidden" name="filedata" value="<?php echo (isset($data_pembayaran_pensiun_aip_ket_smt2[0]->file_lap) ? $data_pembayaran_pensiun_aip_ket_smt2[0]->file_lap : '');?>">
                                                <input type="file" name="filedata">
                                                <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                                                <a href="<?php echo site_url('semesteran/aspek_operasional/get_file/'.(isset($data_pembayaran_pensiun_aip_ket_smt2[0]->id) ? $data_pembayaran_pensiun_aip_ket_smt2[0]->id : ''));?>"><p><?php echo (isset($data_pembayaran_pensiun_aip_ket_smt2[0]->file_lap) ? $data_pembayaran_pensiun_aip_ket_smt2[0]->file_lap : '');?></p></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer with-border">
                                            <div class="col-sm-12">
