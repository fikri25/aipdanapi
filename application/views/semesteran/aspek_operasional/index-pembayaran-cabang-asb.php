 					...
 					<div class="col-md-12">
 						<div class="row">
                            ...
                            <div class="col-md-3">
 							...
 							<div class="col-md-1">
 								<div class="form-group">
 									<a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-pembayaran-cabang','index-pembayaran-cabang');">
                            ...
                            <div  class="col-md-4"> 
                                ...
                                <div class="form-group pull-right">
                                    <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'pembayaran_pensiun_cabang_cetak','pembayaran_pensiun_cabang_cetak');"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak PDF</a>  
                                    &nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
 						</div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-group-sm">
                                    <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_operasional/save_keterangan'?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="nmdok" value="Pembayaran_Pensiun_Cabang_Semester">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <a href="<?php echo site_url('semesteran/aspek_operasional/get_file/'.(isset($data_pembayaran_pensiun_cbg_ket_smt1[0]->id) ? $data_pembayaran_pensiun_cbg_ket_smt1[0]->id : ''));?>"><p><?php echo (isset($data_pembayaran_pensiun_cbg_ket_smt1[0]->file_lap) ? $data_pembayaran_pensiun_cbg_ket_smt1[0]->file_lap : '');?></p></a>
                                            </div>
                                        </div>
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'semesteran/aspek_operasional/save_keterangan'?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="file" name="filedata">
                                                <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                                                <a href="<?php echo site_url('semesteran/aspek_operasional/get_file/'.(isset($data_pembayaran_pensiun_cbg_ket_smt2[0]->id) ? $data_pembayaran_pensiun_cbg_ket_smt2[0]->id : ''));?>"><p><?php echo (isset($data_pembayaran_pensiun_cbg_ket_smt2[0]->file_lap) ? $data_pembayaran_pensiun_cbg_ket_smt2[0]->file_lap : '');?></p></a>
                                            </div>
                                        </div>
                                        <div class="modal-footer with-border">
                                            <div class="col-sm-12">
