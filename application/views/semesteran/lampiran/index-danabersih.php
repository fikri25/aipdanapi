        ...
        <div class="box-body" style="overflow-x:auto;">
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-1">
                <div class="form-group">
                  <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-lampiran-danabersih','index-lampiran-danabersih');">
              ...
              <div  class="col-md-4"> 
                <div class="form-group dropdown pull-right user">
                  ...
                  <div class="form-group pull-right">
                    <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'lampiran_danabersih_cetak','lampiran_danabersih_cetak');">
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/operasional_belanja/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="nmdok" value="Lkob_Dana_Bersih_Semester">
