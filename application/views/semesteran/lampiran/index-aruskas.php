                        ...
                        <div class="box-body" style="overflow-x:auto;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensemestersearch('index-lampiran-aruskas','index-lampiran-aruskas');">
                                    ...
                                    <div  class="col-md-4"> 
                                        <div class="form-group dropdown pull-right user">
                                            <button class="btn btn-sm btn-warning btn-flat dropdown-toggle user" type="button" data-toggle="dropdown"><i class="fa fa-info-circle"></i> Keterangan
                                        ...
                                        <div class="form-group pull-right">
                                            <a href="javascript:void(0)" title="Add" class="btn btn-danger btn-sm btn-flat" onClick="genformsemester('print-all', 'lampiran_aruskas_cetak','lampiran_aruskas_cetak');">
          ...
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'semesteran/operasional_belanja/save_keterangan'?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="nmdok" value="Lkob_Arus_Kas_Semester">
