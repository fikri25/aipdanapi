...
! function(e, t) {
    ...
    return function(i) {
        ...
        return a.m = i, a.c = n, a.d = function(e, t, i) {
        ...
        var p = function() {
            function I() {
                ...
                var n = I._setArgumentsValues(e, t, i),
                    ...
                    s = n.initialValue,
                    o = n.userOptions;
                if (this.domElement = a, this.defaultRawValue = "", this._setSettings(o, !1), this._checkElement(), this.savedCancellableValue = null, this.historyTable = [], this.historyTableIndex = -1, this.onGoingRedo = !1, this.parentForm = this._getParentForm(), !this.runOnce && this.settings.formatOnPageLoad) this._formatDefaultValueOnPageLoad(s);
                else {
                    var l = void 0;
                    if (D.default.isNull(s)) switch (this.settings.emptyInputBehavior) {
                ...
                this.runOnce = !0, this.hasEventListeners = !1, (this.isInputElement || this.isContentEditable) && (this.settings.noEventListeners || this._createEventListeners(), this._setWritePermissions(!0)), this._saveInitialValues(s), this.sessionStorageAvailable = this.constructor._storageTest(), this.storageNamePrefix = "AUTO_", this._setPersistentStorageName(), this.isFocused = !1, this.isWheelEvent = !1, this.isDropEvent = !1, this.isEditing = !1, this.rawValueOnFocus = void 0, this.internalModification = !1, this.attributeToWatch = this._getAttributeToWatch(), this.getterSetter = Object.getOwnPropertyDescriptor(this.domElement.__proto__, this.attributeToWatch), this._addWatcher(), this.settings.createLocalList && this._createLocalList(), this.constructor._addToGlobalList(this), this.global = {
                    ...
                    get: function() {
                        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
                            t = [];
                        return r.autoNumericLocalList.forEach(function(e) {
                            t.push(e.get())
                        }), r._executeCallback(t, e), t
                    },
                    ...
                    removeObject: function(e) {
                        ...
                        r.autoNumericLocalList.delete(i), a.forEach(function(e) {
                    ...
                    reset: function() {
                        return r.settings = {
                            rawValue: r.defaultRawValue
                        }, r.update(I.defaultSettings), r
                    },
                    ...
                    emptyInputBehavior: function(e) {
                        return null === r.rawValue && e !== I.options.emptyInputBehavior.null && (D.default.warning("You are trying to modify the `emptyInputBehavior` option to something different than `'null'` (" + e + "), but the element raw value is currently set to `null`. This would result in an invalid `rawValue`. In order to fix that, the element value has been changed to the empty string `''`.", r.settings.showWarnings), r.rawValue = ""), r.update({
                    ...
                    noEventListeners: function(e) {
                        return e === I.options.noEventListeners.noEvents && r.settings.noEventListeners === I.options.noEventListeners.addEvents && r._removeEventListeners(), r.update({
                            noEventListeners: e
                        }), r
                    },
                ...
                }, this._triggerEvent(I.events.initialized, this.domElement, {
            ...
            return n(I, [{
                ...
                value: function(e) {
                    this.initialValueHtmlAttribute = D.default.scientificToDecimal(this.domElement.getAttribute("value")), D.default.isNull(this.initialValueHtmlAttribute) && (this.initialValueHtmlAttribute = ""), this.initialValue = e, D.default.isNull(this.initialValue) && (this.initialValue = "")
                }
            }, {
                ...
                value: function() {
                    var e = void 0;
                    if (0 < arguments.length && void 0 !== arguments[0] && !arguments[0] ? (e = this.historyTableIndex + 1 < this.historyTable.length) && this.historyTableIndex++ : (e = 0 < this.historyTableIndex) && this.historyTableIndex--, e) {
                ...
                value: function() {
                    for (var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 1, t = [], i = 0; i < e; i++) t.push(this.historyTable.shift()), this.historyTableIndex--, this.historyTableIndex < 0 && (this.historyTableIndex = 0);
                ...
                value: function() {
                    var n = this;
                    D.default.isUndefinedOrNullOrEmpty(this.settings.styleRules) || "" === this.rawValue || (D.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.positive) || (0 <= this.rawValue ? this._addCSSClass(this.settings.styleRules.positive) : this._removeCSSClass(this.settings.styleRules.positive)), D.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.negative) || (this.rawValue < 0 ? this._addCSSClass(this.settings.styleRules.negative) : this._removeCSSClass(this.settings.styleRules.negative)), D.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.ranges) || 0 === this.settings.styleRules.ranges.length || this.settings.styleRules.ranges.forEach(function(e) {
                        n.rawValue >= e.min && n.rawValue < e.max ? n._addCSSClass(e.class) : n._removeCSSClass(e.class)
                    }), D.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.userDefined) || 0 === this.settings.styleRules.userDefined.length || this.settings.styleRules.userDefined.forEach(function(e) {
                        if (D.default.isFunction(e.callback))
                            ...
                            D.default.isArray(i) ? e.classes.forEach(function(e, t) {
                                D.default.isInArray(t, i) ? n._addCSSClass(e) : n._removeCSSClass(e)
                            }) : D.default.isInt(i) ? e.classes.forEach(function(e, t) {
                                t === i ? n._addCSSClass(e) : n._removeCSSClass(e)
                            }) : D.default.isNull(i) ? e.classes.forEach(function(e) {
                                n._removeCSSClass(e)
                ...
                value: function() {
                    ...
                    var a = D.default.cloneObject(this.settings),
                        r = this.rawValue,
                        s = {};
                    D.default.isUndefinedOrNullOrEmpty(i) || 0 === i.length ? s = null : 1 <= i.length && i.forEach(function(e) {
                ...
                value: function(e) {
                    ...
                    if (D.default.isNull(t) || this._setSettings(t, !0), null === e && this.settings.emptyInputBehavior !== I.options.emptyInputBehavior.null) return D.default.warning("You are trying to set the `null` value while the `emptyInputBehavior` option is set to " + this.settings.emptyInputBehavior + ". If you want to be able to set the `null` value, you need to change the 'emptyInputBehavior' option to `'null'`.", this.settings.showWarnings), this;
                    var n, a = void 0;
                    if (null === e) return this._setElementAndRawValue(null, null, i), this._saveValueToPersistentStorage(), this;
                    if (a = this.constructor._toNumericValue(e, this.settings), isNaN(Number(a))) return D.default.warning("The value you are trying to set results in `NaN`. The element value is set to the empty string instead.", this.settings.showWarnings), this.setValue("", i), this;
                ...
                value: function(e) {
                    ...
                    if (this.rawValue !== e) {
                        var i = this.rawValue;
                        this.rawValue = e, !D.default.isNull(this.settings.rawValueDivisor) && 0 !== this.settings.rawValueDivisor && "" !== e && null !== e && this._isUserManuallyEditingTheValue() && (this.rawValue /= this.settings.rawValueDivisor), this._triggerEvent(I.events.rawValueModified, this.domElement, {
                            oldRawValue: i,
                            newRawValue: this.rawValue,
                            isPristine: this.isPristine(!0),
                            error: null,
                            aNElement: this
                        }), this._parseStyleRules(), t && this._historyTableAdd()
                    }
                }
            }, {
                ...
                value: function(e) {
                    ...
                    return e !== i && (this.internalModification = !0, D.default.setElementValue(this.domElement, e), this.internalModification = !1, t && this._triggerEvent(I.events.formatted, this.domElement, {
                        oldValue: i,
                        newValue: e,
                ...
                value: function() {
                    ...
                    var i, n = void 0;
                    "" != (n = D.default.isEmptyString(this.rawValue) ? "" : "" + Number(this.rawValue)) && 0 === Number(n) && this.settings.leadingZero !== I.options.leadingZero.keep && (n = "0"), i = D.default.isNull(e) ? this.settings.outputFormat : e;
                ...
                key: "selectNumber",
                value: function() {
                    var e, t = D.default.getElementValue(this.domElement),
                        i = t.length,
                ...
                value: function() {
                    ...
                    return -1 === n && (n = this.settings.currencySymbolPlacement === I.options.currencySymbolPlacement.suffix ? i.length - this.settings.currencySymbol.length : i.length, t || this.settings.negativePositiveSignPlacement !== I.options.negativePositiveSignPlacement.suffix && this.settings.currencySymbolPlacement !== I.options.currencySymbolPlacement.suffix || (n -= 1), n -= this.settings.suffixText.length), D.default.setElementSelection(this.domElement, e, n), this
                }
            }, {
                key: "selectDecimal",
                value: function() {
                    var e, t = D.default.getElementValue(this.domElement).indexOf(this.settings.decimalCharacter),
                        i = void 0;
                    return i = -1 === t ? t = 0 : (t += 1, e = this.isFocused ? this.settings.decimalPlacesShownOnFocus : this.settings.decimalPlacesShownOnBlur, t + Number(e)), D.default.setElementSelection(this.domElement, t, i), this
                }
            }, {
                key: "node",
                value: function() {
                ...
                value: function(e, t) {
                    var i, n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
                ...
                value: function(e) {
                    var n = this,
                        ...
                        t = !1,
                        i = [];
                    if (D.default.isString(e) ? i = [].concat(g(document.querySelectorAll(e))) : D.default.isElement(e) ? (i.push(e), t = !0) : D.default.isArray(e) ? i = e : D.default.throwError("The given parameters to the 'init' function are invalid."), 0 === i.length) return D.default.warning("No valid DOM elements were given hence no AutoNumeric object were instantiated.", !0), [];
                ...
                value: function() {
                    if (0 < arguments.length && void 0 !== arguments[0] && arguments[0]) {
                        var e = {
                            emptyInputBehavior: I.options.emptyInputBehavior.focus
                        };
                        this.set("", e)
                    } else this.set("");
                    return this
                ...
                value: function() {
                    this.isTrailingNegative = this.settings.currencySymbolPlacement === I.options.currencySymbolPlacement.prefix && this.settings.negativePositiveSignPlacement === I.options.negativePositiveSignPlacement.suffix || this.settings.currencySymbolPlacement === I.options.currencySymbolPlacement.suffix && (this.settings.negativePositiveSignPlacement === I.options.negativePositiveSignPlacement.left || this.settings.negativePositiveSignPlacement === I.options.negativePositiveSignPlacement.right)
                }
            }, {
                ...
                value: function(e) {
                    D.default.isNull(this.settings.caretPositionOnFocus) && this.settings.selectOnFocus === I.options.selectOnFocus.doNotSelect && D.default.throwError("`_initialCaretPosition()` should never be called when the `caretPositionOnFocus` option is `null`.");
                ...
                value: function() {
                    return this.settings.saveValueToSessionStorage ? this.sessionStorageAvailable ? sessionStorage.getItem(this.rawValueStorageName) : this.constructor._readCookie(this.rawValueStorageName) : (D.default.warning("`_getValueFromPersistentStorage()` is called but `settings.saveValueToSessionStorage` is false. There must be an error that needs fixing.", this.settings.showWarnings), null)
                }
            }, {
                ...
                value: function(e) {
                    if (this.isEditing = !1, !this.formulaMode && this.settings.unformatOnHover && "mouseenter" === e.type && e.altKey) this.constructor._unformatAltHovered(this);
                        ...
                        var t = null;
                        this.settings.emptyInputBehavior === I.options.emptyInputBehavior.focus && this.rawValue < 0 && null !== this.settings.negativeBracketsTypeOnBlur && this.settings.isNegativeSignAllowed && (t = this.constructor._removeBrackets(D.default.getElementValue(this.domElement), this.settings));
                        ...
                        s && (t = r), D.default.isNull(t) || this._setElementValue(t), s && r === this.settings.currencySymbol && this.settings.currencySymbolPlacement === I.options.currencySymbolPlacement.suffix && D.default.setElementSelection(e.target, 0)
                    }
                }
            }, {
                key: "_onFocus",
                ...
                value: function() {
                    ...
                    try {
                        ...
                        return this._triggerEvent(I.events.invalidFormula, this.domElement, {
                            formula: t,
                            aNElement: this
                        }), this.reformat(), void(this.formulaMode = !1)
                    }
                    this._triggerEvent(I.events.validFormula, this.domElement, {
                        formula: t,
                        result: e,
                        aNElement: this
                ...
                value: function() {
                    return this.eventKey === v.default.keyName.Backspace || this.eventKey === v.default.keyName.Delete || this.eventKey === v.default.keyName.LeftArrow || this.eventKey === v.default.keyName.RightArrow || this.eventKey === v.default.keyName.Home || this.eventKey === v.default.keyName.End
                }
            }, {
                key: "_onKeydown",
                value: function(e) {
                    if (this.formatted = !1, this.isEditing = !0, this.formulaMode || this.isFocused || !this.settings.unformatOnHover || !e.altKey || this.domElement !== D.default.getHoveredElement()) {
                        if (this._updateEventKeyInfo(e), this.initialValueOnKeydown = D.default.getElementValue(e.target), this.initialRawValueOnKeydown = this.rawValue, this.keydownEventCounter += 1, 1 === this.keydownEventCounter && (this.initialRawValueOnFirstKeydown = this.rawValue), this.formulaMode) {
                        ...
                        if (this.domElement.readOnly || this.settings.readOnly || this.domElement.disabled) this.processed = !0;
                            ...
                            this.eventKey === v.default.keyName.Esc && (e.preventDefault(), this.settings.isCancellable && this.rawValue !== this.savedCancellableValue && (this.set(this.savedCancellableValue), this._triggerEvent(I.events.native.input, e.target)), this.select());
                            ...
                            if (t) e.preventDefault();
                                ...
                                if (this._processCharacterInsertion()) {
                                    ...
                                    if (i !== this.lastVal && this.throwInput) this._triggerEvent(I.events.native.input, e.target), e.preventDefault();
                                        ...
                                        if ((this.eventKey === this.settings.decimalCharacter || this.eventKey === this.settings.decimalCharacterAlternative) && D.default.getElementSelection(e.target).start === D.default.getElementSelection(e.target).end && D.default.getElementSelection(e.target).start === i.indexOf(this.settings.decimalCharacter)) {
                ...
                value: function(e) {
                    if (this.isEditing = !1, "mouseleave" !== e.type || !this.formulaMode)
                        ...
                        var t = this._getRawValueToFormat(this.rawValue),
                            ...
                            s = a[1],
                            o = !1;
                        if ("" === t || i || (r || this._triggerEvent(I.events.minRangeExceeded, this.domElement), s || this._triggerEvent(I.events.maxRangeExceeded, this.domElement), this.settings.valuesToStrings && this._checkValuesToStrings(t) && (this._setElementValue(this.settings.valuesToStrings[t]), o = !0)), !o) {
                            var l = void 0;
                            if (l = i || "" === t ? t : String(t), "" === t || i) {
                                if ("" === t) switch (this.settings.emptyInputBehavior) {
                                    ...
                                    case I.options.emptyInputBehavior.max:
                                        ...
                                        break;
                                    default:
                                        D.default.isNumber(this.settings.emptyInputBehavior) && (this._setRawValue(this.settings.emptyInputBehavior), l = this.constructor._roundFormattedValueShownOnFocusOrBlur(this.settings.emptyInputBehavior, this.settings, this.isFocused))
                                }
                            } else r && s && !this.constructor._isElementValueEmptyOrOnlyTheNegativeSign(t, this.settings) ? (l = this._modifyNegativeSignAndDecimalCharacterForRawValue(l), this.settings.divisorWhenUnfocused && !D.default.isNull(l) && (l = (l /= this.settings.divisorWhenUnfocused).toString()), l = this.constructor._roundFormattedValueShownOnBlur(l, this.settings), l = this.constructor._modifyNegativeSignAndDecimalCharacterForFormattedValue(l, this.settings)) : (r || this._triggerEvent(I.events.minRangeExceeded, this.domElement), s || this._triggerEvent(I.events.maxRangeExceeded, this.domElement));
                            var u = this.constructor._orderValueCurrencySymbolAndSuffixText(l, this.settings, !1);
                            this.constructor._isElementValueEmptyOrOnlyTheNegativeSign(l, this.settings) || i && this.settings.emptyInputBehavior === I.options.emptyInputBehavior.null || (u = this.constructor._addGroupSeparators(l, this.settings, !1, t)), u === t && "" !== t && this.settings.allowDecimalPadding !== I.options.allowDecimalPadding.never && this.settings.allowDecimalPadding !== I.options.allowDecimalPadding.floats || (this.settings.symbolWhenUnfocused && "" !== t && null !== t && (u = "" + u + this.settings.symbolWhenUnfocused), this._setElementValue(u))
                        }
                ...
                value: function(e) {
                    if (e.preventDefault(), !(this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled)) {
                        var t, i = void 0;
                        window.clipboardData && window.clipboardData.getData ? i = window.clipboardData.getData("Text") : e.clipboardData && e.clipboardData.getData ? i = e.clipboardData.getData("text/plain") : D.default.throwError("Unable to retrieve the pasted value. Please use a modern browser (ie. Firefox or Chromium)."), t = e.target.tagName ? e.target : e.explicitOriginalTarget;
                        ...
                        if (s === n.length) {
                            ...
                            return "." === l || "" === l || "." !== l && !D.default.isNumber(l) ? (this.formatted = !0, void(this.settings.onInvalidPaste === I.options.onInvalidPaste.error && D.default.throwError("The pasted value '" + i + "' is not a valid paste content."))) : (this.set(l), this.formatted = !0, void this._triggerEvent(I.events.native.input, t))
                        }
                        var u = D.default.isNegativeStrict(i, this.settings.negativeSignCharacter);
                        u && (i = i.slice(1, i.length));
                        var c, h = this._preparePastedText(i);
                        if ("." !== (c = "." === h ? "." : D.default.arabicToLatinNumbers(h, !1, !1, !1)) && (!D.default.isNumber(c) || "" === c)) return this.formatted = !0, void(this.settings.onInvalidPaste === I.options.onInvalidPaste.error && D.default.throwError("The pasted value '" + i + "' is not a valid paste content."));
                        var d, m = void 0,
                        ...
                        g = a !== r ? this._preparePastedText(v + p) : this._preparePastedText(n), f && (g = D.default.setRawNegativeSign(g)), m = D.default.convertCharacterCountToIndexPosition(D.default.countNumberCharactersOnTheCaretLeftSide(n, a, this.settings.decimalCharacter)), d && m++;
                        var y = g.slice(0, m),
                        ...
                        switch ("" === y && "-" === S && (y = "-", w = !(S = "")), this.settings.onInvalidPaste) {
                            ...
                            case I.options.onInvalidPaste.replace:
                                for (var P = D.default.parseStr(this.settings.minimumValue), O = D.default.parseStr(this.settings.maximumValue), k = g, N = 0, E = y; N < c.length && (g = (E += c[N]) + S, this.constructor._checkIfInRange(g, P, O));) k = g, N++;
                        ...
                        if (D.default.isNumber(g) && "" !== g) {
                            ...
                            if (V) switch (this.settings.onInvalidPaste) {
                                case I.options.onInvalidPaste.clamp:
                                    if (T) {
                                        this.settings.currencySymbolPlacement === I.options.currencySymbolPlacement.suffix ? D.default.setElementSelection(t, L.length - this.settings.currencySymbol.length) : D.default.setElementSelection(t, L.length);
                                        break
                                    }
                                    case I.options.onInvalidPaste.error:
                                    case I.options.onInvalidPaste.ignore:
                ...
                key: "_onWheel",
                value: function(e) {
                    this.formulaMode || this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled || this.settings.modifyValueOnWheel && (this.settings.wheelOn === I.options.wheelOn.focus ? this.isFocused ? e.shiftKey || this.wheelAction(e) : e.shiftKey && this.wheelAction(e) : this.settings.wheelOn === I.options.wheelOn.hover ? e.shiftKey ? (e.preventDefault(), window.scrollBy(0, D.default.isNegativeStrict(String(e.deltaY)) ? -50 : 50)) : this.wheelAction(e) : D.default.throwError("Unknown `wheelOn` option."))
                }
            }, {
                key: "wheelAction",
                value: function(e) {
                    ...
                    var t = e.target.selectionStart || 0,
                        ...
                        n = this.rawValue,
                        a = void 0;
                    if (D.default.isUndefinedOrNullOrEmpty(n) ? 0 < this.settings.minimumValue || this.settings.maximumValue < 0 ? D.default.isWheelUpEvent(e) ? a = this.settings.minimumValue : D.default.isWheelDownEvent(e) ? a = this.settings.maximumValue : D.default.throwError("The event is not a 'wheel' event.") : a = 0 : a = n, a = +a, D.default.isNumber(this.settings.wheelStep)) {
                        var r = +this.settings.wheelStep;
                        D.default.isWheelUpEvent(e) ? a += r : D.default.isWheelDownEvent(e) && (a -= r)
                    } else D.default.isWheelUpEvent(e) ? a = D.default.addAndRoundToNearestAuto(a, this.settings.decimalPlacesRawValue) : D.default.isWheelDownEvent(e) && (a = D.default.subtractAndRoundToNearestAuto(a, this.settings.decimalPlacesRawValue));
                ...
                value: function() {
                    ...
                    if (D.default.isNull(e) ? (i = D.default.getElementValue(this.domElement).trim(), this.domElement.setAttribute("value", i)) : i = e, this.isInputElement || this.isContentEditable) {
                        ...
                        if (this.domElement.hasAttribute("value") && "" !== this.domElement.getAttribute("value")) {
                            if (null !== this.settings.defaultValueOverride && this.settings.defaultValueOverride.toString() !== i || null === this.settings.defaultValueOverride && "" !== i && i !== this.domElement.getAttribute("value") || "" !== i && "hidden" === this.domElement.getAttribute("type") && !D.default.isNumber(n)) {
                ...
                value: function() {
                    var e = this.settings.maximumValue.toString().split("."),
                        ...
                        n = S(i, 1)[0];
                    t = t.replace(this.settings.negativeSignCharacter, ""), n = n.replace(this.settings.negativeSignCharacter, ""), this.settings.mIntPos = Math.max(t.length, 1), this.settings.mIntNeg = Math.max(n.length, 1)
                }
            }, {
                ...
                value: function(e) {
                    ...
                    }), this.caretFix = !1, this.throwInput = !0, this.allowedTagList = v.default.allowedTagList, this.runOnce = !1, this.hoveredWithAlt = !1), this._transformOptionsValuesToDefaultTypes(), this._runCallbacksFoundInTheSettingsObject(), this.constructor._correctNegativePositiveSignPlacementOption(this.settings), this.constructor._correctCaretPositionOnFocusAndSelectOnFocusOptions(this.settings), this.constructor._setNegativePositiveSignPermissions(this.settings), t || (D.default.isNull(e) || !e.decimalPlaces ? this.settings.originalDecimalPlaces = null : this.settings.originalDecimalPlaces = e.decimalPlaces, this.settings.originalDecimalPlacesRawValue = this.settings.decimalPlacesRawValue, this.constructor._calculateDecimalPlacesOnInit(this.settings)), this._calculateVMinAndVMaxIntegerSizes(), this._setTrailingNegativeSignInfo(), this.regex = {}, this.constructor._cachesUsualRegularExpressions(this.settings, this.regex), this.constructor._setBrackets(this.settings), this._calculateValuesToStringsKeys(), D.default.isEmptyObj(this.settings) && D.default.throwError("Unable to set the settings, those are invalid ; an empty object was given."), this.constructor.validate(this.settings, !1, e), this._keepAnOriginalSettingsCopy()
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    if (c && h) {
                        ...
                        var f = I._truncateDecimalPlaces(o, this.settings, i, this.settings.decimalPlacesShownOnFocus),
                            g = r.length;
                        return g > f.length && (g = f.length), 1 === g && "0" === r && this.settings.leadingZero === I.options.leadingZero.deny && (g = "" === s || "0" === r && "" !== s ? 1 : 0), this._setElementValue(f, !1), this._setCaretPosition(g), !0
                    }
                ...
                value: function(e) {
                    ...
                    if ("keydown" === e.type && !e.shiftKey) {
                        var t = D.default.getElementValue(this.domElement);
                        this.eventKey !== v.default.keyName.LeftArrow || t.charAt(this.selection.start - 2) !== this.settings.digitGroupSeparator && t.charAt(this.selection.start - 2) !== this.settings.decimalCharacter ? this.eventKey !== v.default.keyName.RightArrow || t.charAt(this.selection.start + 1) !== this.settings.digitGroupSeparator && t.charAt(this.selection.start + 1) !== this.settings.decimalCharacter || this._setCaretPosition(this.selection.start + 1) : this._setCaretPosition(this.selection.start - 1)
                    }
                    return !0
                }
            }, {
                ...
                value: function() {
                    ...
                    if (this.selection.length) {
                        ...
                        var a = this._getUnformattedLeftAndRightPartAroundTheSelection(),
                            r = S(a, 2);
                        if (e = r[0], t = r[1], "" === e && "" === t && (this.throwInput = !1), this.isTrailingNegative && D.default.isNegative(D.default.getElementValue(this.domElement), this.settings.negativeSignCharacter)) {
                ...
                value: function() {
                    var e = this._getUnformattedLeftAndRightPartAroundTheSelection(),
                        ...
                        i = t[0],
                        n = t[1];
                    if (this.eventKey !== v.default.keyName.AndroidDefault && (this.throwInput = !0), this.eventKey === this.settings.decimalCharacter || this.settings.decimalCharacterAlternative && this.eventKey === this.settings.decimalCharacterAlternative) {
                        ...
                        return this.settings.negativeSignCharacter && D.default.contains(n, this.settings.negativeSignCharacter) && (i = "" + this.settings.negativeSignCharacter + i, n = n.replace(this.settings.negativeSignCharacter, "")), this._setValueParts(i + this.settings.decimalCharacter, n), !0
                    }
                    if (("-" === this.eventKey || "+" === this.eventKey) && this.settings.isNegativeSignAllowed) return "" === i && D.default.contains(n, "-") ? n = n.replace("-", "") : i = D.default.isNegativeStrict(i, "-") ? i.replace("-", "") : "" + this.settings.negativeSignCharacter + i, this._setValueParts(i, n), !0;
                    var a = Number(this.eventKey);
                    return 0 <= a && a <= 9 ? (this.settings.isNegativeSignAllowed && "" === i && D.default.contains(n, "-") && (i = "-", n = n.substring(1, n.length)), this.settings.maximumValue <= 0 && this.settings.minimumValue < this.settings.maximumValue && !D.default.contains(D.default.getElementValue(this.domElement), this.settings.negativeSignCharacter) && "0" !== this.eventKey && (i = "-" + i), this._setValueParts("" + i + this.eventKey, n), !0) : this.throwInput = !1
                }
            }, {
                key: "_formatValue",
                value: function(e) {
                ...
                value: function(e) {
                    var t = void 0;
                    return D.default.isString(e) ? null == (t = I.getPredefinedOptions()[e]) && D.default.warning("The given pre-defined option [" + e + "] is not recognized by autoNumeric. Please check that pre-defined option name.", !0) : t = e, t
                }
            }, {
                ...
                value: function(e) {
                    ...
                    D.default.isTrueOrFalseString(a.eventBubbles) || D.default.isBoolean(a.eventBubbles) || D.default.throwError("The event bubbles option 'eventBubbles' is invalid ; it should be either 'true' or 'false', [" + a.eventBubbles + "] given."), D.default.isTrueOrFalseString(a.eventIsCancelable) || D.default.isBoolean(a.eventIsCancelable) || D.default.throwError("The event is cancelable option 'eventIsCancelable' is invalid ; it should be either 'true' or 'false', [" + a.eventIsCancelable + "] given."), D.default.isInArray(a.leadingZero, [I.options.leadingZero.allow, I.options.leadingZero.deny, I.options.leadingZero.keep]) || D.default.throwError("The leading zero behavior option 'leadingZero' is invalid ; it should either be 'allow', 'deny' or 'keep', [" + a.leadingZero + "] given."), D.default.isTrueOrFalseString(a.formatOnPageLoad) || D.default.isBoolean(a.formatOnPageLoad) || D.default.throwError("The format on initialization option 'formatOnPageLoad' is invalid ; it should be either 'true' or 'false', [" + a.formatOnPageLoad + "] given."), D.default.isTrueOrFalseString(a.formulaMode) || D.default.isBoolean(a.formulaMode) || D.default.throwError("The formula mode option 'formulaMode' is invalid ; it should be either 'true' or 'false', [" + a.formulaMode + "] given."), s.test(a.historySize) && 0 !== a.historySize || D.default.throwError("The history size option 'historySize' is invalid ; it should be a positive integer, [" + a.historySize + "] given."), D.default.isTrueOrFalseString(a.selectNumberOnly) || D.default.isBoolean(a.selectNumberOnly) || D.default.throwError("The select number only option 'selectNumberOnly' is invalid ; it should be either 'true' or 'false', [" + a.selectNumberOnly + "] given."), D.default.isTrueOrFalseString(a.selectOnFocus) || D.default.isBoolean(a.selectOnFocus) || D.default.throwError("The select on focus option 'selectOnFocus' is invalid ; it should be either 'true' or 'false', [" + a.selectOnFocus + "] given."), D.default.isNull(a.defaultValueOverride) || "" === a.defaultValueOverride || l.test(a.defaultValueOverride) || D.default.throwError("The unformatted default value option 'defaultValueOverride' is invalid ; it should be a string that represents a positive or negative number, [" + a.defaultValueOverride + "] given."), D.default.isTrueOrFalseString(a.unformatOnSubmit) || D.default.isBoolean(a.unformatOnSubmit) || D.default.throwError("The remove formatting on submit option 'unformatOnSubmit' is invalid ; it should be either 'true' or 'false', [" + a.unformatOnSubmit + "] given."), D.default.isNull(a.valuesToStrings) || D.default.isObject(a.valuesToStrings) || D.default.throwError("The option 'valuesToStrings' is invalid ; it should be an object, ideally with 'key -> value' entries, [" + a.valuesToStrings + "] given."), D.default.isNull(a.outputFormat) || D.default.isInArray(a.outputFormat, [I.options.outputFormat.string, I.options.outputFormat.number, I.options.outputFormat.dot, I.options.outputFormat.negativeDot, I.options.outputFormat.comma, I.options.outputFormat.negativeComma, I.options.outputFormat.dotNegative, I.options.outputFormat.commaNegative]) || D.default.throwError("The custom locale format option 'outputFormat' is invalid ; it should either be null, 'string', 'number', '.', '-.', ',', '-,', '.-' or ',-', [" + a.outputFormat + "] given."), D.default.isTrueOrFalseString(a.isCancellable) || D.default.isBoolean(a.isCancellable) || D.default.throwError("The cancellable behavior option 'isCancellable' is invalid ; it should be either 'true' or 'false', [" + a.isCancellable + "] given."), D.default.isTrueOrFalseString(a.modifyValueOnWheel) || D.default.isBoolean(a.modifyValueOnWheel) || D.default.throwError("The increment/decrement on mouse wheel option 'modifyValueOnWheel' is invalid ; it should be either 'true' or 'false', [" + a.modifyValueOnWheel + "] given."), D.default.isTrueOrFalseString(a.watchExternalChanges) || D.default.isBoolean(a.watchExternalChanges) || D.default.throwError("The option 'watchExternalChanges' is invalid ; it should be either 'true' or 'false', [" + a.watchExternalChanges + "] given."), D.default.isInArray(a.wheelOn, [I.options.wheelOn.focus, I.options.wheelOn.hover]) || D.default.throwError("The wheel behavior option 'wheelOn' is invalid ; it should either be 'focus' or 'hover', [" + a.wheelOn + "] given."), (!D.default.isString(a.wheelStep) && !D.default.isNumber(a.wheelStep) || "progressive" !== a.wheelStep && !u.test(a.wheelStep) || 0 === Number(a.wheelStep)) && D.default.throwError("The wheel step value option 'wheelStep' is invalid ; it should either be the string 'progressive', or a number or a string that represents a positive number (excluding zero), [" + a.wheelStep + "] given."), D.default.isInArray(a.serializeSpaces, [I.options.serializeSpaces.plus, I.options.serializeSpaces.percent]) || D.default.throwError("The space replacement character option 'serializeSpaces' is invalid ; it should either be '+' or '%20', [" + a.serializeSpaces + "] given."), D.default.isTrueOrFalseString(a.noEventListeners) || D.default.isBoolean(a.noEventListeners) || D.default.throwError("The option 'noEventListeners' that prevent the creation of event listeners is invalid ; it should be either 'true' or 'false', [" + a.noEventListeners + "] given."), D.default.isNull(a.styleRules) || D.default.isObject(a.styleRules) && (a.styleRules.hasOwnProperty("positive") || a.styleRules.hasOwnProperty("negative") || a.styleRules.hasOwnProperty("ranges") || a.styleRules.hasOwnProperty("userDefined")) || D.default.throwError("The option 'styleRules' is invalid ; it should be a correctly structured object, with one or more 'positive', 'negative', 'ranges' or 'userDefined' attributes, [" + a.styleRules + "] given."), D.default.isNull(a.styleRules) || !a.styleRules.hasOwnProperty("userDefined") || D.default.isNull(a.styleRules.userDefined) || a.styleRules.userDefined.forEach(function(e) {
                        e.hasOwnProperty("callback") && !D.default.isFunction(e.callback) && D.default.throwError("The callback defined in the `userDefined` attribute is not a function, " + b(e.callback) + " given.")
                    }), (D.default.isNull(a.rawValueDivisor) || u.test(a.rawValueDivisor)) && 0 !== a.rawValueDivisor && "0" !== a.rawValueDivisor && 1 !== a.rawValueDivisor && "1" !== a.rawValueDivisor || D.default.throwError("The raw value divisor option 'rawValueDivisor' is invalid ; it should be a positive number higher than one, preferably an integer, [" + a.rawValueDivisor + "] given."), D.default.isTrueOrFalseString(a.readOnly) || D.default.isBoolean(a.readOnly) || D.default.throwError("The option 'readOnly' is invalid ; it should be either 'true' or 'false', [" + a.readOnly + "] given."), D.default.isTrueOrFalseString(a.unformatOnHover) || D.default.isBoolean(a.unformatOnHover) || D.default.throwError("The option 'unformatOnHover' is invalid ; it should be either 'true' or 'false', [" + a.unformatOnHover + "] given."), D.default.isTrueOrFalseString(a.failOnUnknownOption) || D.default.isBoolean(a.failOnUnknownOption) || D.default.throwError("The debug option 'failOnUnknownOption' is invalid ; it should be either 'true' or 'false', [" + a.failOnUnknownOption + "] given."), D.default.isTrueOrFalseString(a.createLocalList) || D.default.isBoolean(a.createLocalList) || D.default.throwError("The debug option 'createLocalList' is invalid ; it should be either 'true' or 'false', [" + a.createLocalList + "] given.")
                }
            }, {
                ...
                value: function(e) {
                    ...
                    var t;
                    t = D.default.isElement(e) ? D.default.getElementValue(e) : e, D.default.isString(t) || D.default.isNumber(t) || D.default.throwError('The value "' + t + '" being "set" is not numeric and therefore cannot be used appropriately.');
                    ...
                    var l = this._checkIfInRangeWithOverrideOption(o, s),
                        ...
                        c = u[0],
                        h = u[1];
                    return c && h || (D.default.triggerEvent(I.events.formatted, document, {
                        oldValue: null,
                        newValue: null,
                        oldRawValue: null,
                        newRawValue: null,
                ...
                value: function(e) {
                    ...
                    var r = this._generateOptionsObjectFromOptionsArray(n),
                        s = y({}, this.getDefaultConfig(), r);
                    if (s.isNegativeSignAllowed = !1, s.isPositiveSignAllowed = !0, t = t.toString(), s.valuesToStrings && this._checkStringsToValuesSettings(t, s)) return D.default.objectKeyLookup(s.valuesToStrings, t);
                    if (D.default.isNegative(t, s.negativeSignCharacter)) s.isNegativeSignAllowed = !0, s.isPositiveSignAllowed = !1;
                        ...
                        var o = s.negativeBracketsTypeOnBlur.split(","),
                            l = S(o, 2);
                        s.firstBracket = l[0], s.lastBracket = l[1], t.charAt(0) === s.firstBracket && t.charAt(t.length - 1) === s.lastBracket && (s.isNegativeSignAllowed = !0, s.isPositiveSignAllowed = !1, t = this._removeBrackets(t, s, !1))
                    }
                ...
                value: function(e) {
                    var t, i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null,
                        n = void 0;
                    return "" === (n = D.default.isElement(e) ? D.default.getElementValue(e) : e) ? "" : (D.default.isNull(i) && (i = I.defaultSettings), n = this.unformat(n, i), 0 === Number(n) && i.leadingZero !== I.options.leadingZero.keep && (n = "0"), t = D.default.isNull(i) ? i.outputFormat : I.defaultSettings.outputFormat, this._toLocale(n, t, i))
                }
            }, {
                key: "localizeAndSet",
                value: function(e) {
                ...
                value: function(e, t) {
                    ...
                    return this.isManagedByAutoNumeric(r) ? this.getAutoNumericElement(r).set(t, n, a) : (i = !(!D.default.isNull(n) && n.hasOwnProperty("showWarnings")) || n.showWarnings, D.default.warning("Impossible to find an AutoNumeric object for the given DOM element or selector.", i), null)
                }
            }, {
                key: "getNumericString",
                value: function(e) {
                ...
                value: function(e, t, i, n) {
                    ...
                    if (e = a ? [a[1], a[2], a[3]].join("") : "", t.leadingZero === I.options.leadingZero.allow || t.leadingZero === I.options.leadingZero.keep) {
                        var r = "",
                            ...
                            u = o[1],
                            c = l;
                        D.default.contains(c, t.negativeSignCharacter) && (r = t.negativeSignCharacter, c = c.replace(t.negativeSignCharacter, "")), "" === r && c.length > t.mIntPos && "0" === c.charAt(0) && (c = c.slice(1)), "" !== r && c.length > t.mIntNeg && "0" === c.charAt(0) && (c = c.slice(1)), e = "" + r + c + (D.default.isUndefined(u) ? "" : t.decimalCharacter + u)
                    }
                ...
                value: function(e, t) {
                    var i = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2],
                        n = void 0;
                    return D.default.isNull(t.negativeBracketsTypeOnBlur) || e.charAt(0) !== t.firstBracket ? e : (n = (n = e.replace(t.firstBracket, "")).replace(t.lastBracket, ""), i ? (n = n.replace(t.currencySymbol, ""), this._mergeCurrencySignNegativePositiveSignAndValue(n, t, !0, !1)) : "" + t.negativeSignCharacter + n)
                }
            }, {
                key: "_setBrackets",
                value: function(e) {
                ...
                value: function(e, t) {
                    e = this._removeBrackets(e, t, !1), e = (e = this._normalizeCurrencySuffixAndNegativeSignCharacters(e, t)).replace(new RegExp("[" + t.digitGroupSeparator + "]", "g"), ""), "." !== t.decimalCharacter && (e = e.replace(t.decimalCharacter, ".")), D.default.isNegative(e) && e.lastIndexOf("-") === e.length - 1 && (e = "-" + (e = e.replace("-", ""))), t.showPositiveSign && (e = e.replace(t.positiveSignCharacter, ""));
                ...
                value: function(e, t) {
                    return e = String(e), t.currencySymbol !== I.options.currencySymbol.none && (e = e.replace(t.currencySymbol, "")), t.suffixText !== I.options.suffixText.none && (e = e.replace(t.suffixText, "")), t.negativeSignCharacter !== I.options.negativeSignCharacter.hyphen && (e = e.replace(t.negativeSignCharacter, "-")), e
                }
            }, {
                key: "_toLocale",
                value: function(e, t, i) {
                ...
                value: function(e, t, i, n) {
                    var a, r = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : null;
                    if (a = D.default.isNull(r) ? D.default.isNegative(e, t.negativeSignCharacter) || D.default.isNegativeWithBrackets(e, t.firstBracket, t.lastBracket) : r < 0, e = this._stripAllNonNumberCharactersExceptCustomDecimalChar(e, t, !1, i), this._isElementValueEmptyOrOnlyTheNegativeSign(e, t)) return this._orderValueCurrencySymbolAndSuffixText(e, t, !0);
                    ...
                    var l, u = e.split(t.decimalCharacter),
                        c = S(u, 2),
                        h = c[0],
                        d = c[1];
                ...
                value: function(e, t, i) {
                    ...
                    var n, a = I._prepareValueForRounding(e, t),
                        r = S(a, 2),
                        s = r[0],
                        o = (e = r[1]).lastIndexOf("."),
                        l = -1 === o,
                ...
                value: function(e, t) {
                    var i = "";
                    return D.default.isNegativeStrict(e, "-") && (i = "-", e = e.replace("-", "")), e.match(/^\d/) || (e = "0" + e), 0 === Number(e) && (i = ""), (0 < Number(e) && t.leadingZero !== I.options.leadingZero.keep || 0 < e.length && t.leadingZero === I.options.leadingZero.allow) && (e = e.replace(/^0*(\d)/, "$1")), [i, e]
                }
            }, {
                key: "_shouldRoundUp",
                value: function(e, t, i, n) {
                    return 4 < e && t.roundingMethod === I.options.roundingMethod.halfUpSymmetric || 4 < e && t.roundingMethod === I.options.roundingMethod.halfUpAsymmetric && "" === i || 5 < e && t.roundingMethod === I.options.roundingMethod.halfUpAsymmetric && "-" === i || 5 < e && t.roundingMethod === I.options.roundingMethod.halfDownSymmetric || 5 < e && t.roundingMethod === I.options.roundingMethod.halfDownAsymmetric && "" === i || 4 < e && t.roundingMethod === I.options.roundingMethod.halfDownAsymmetric && "-" === i || 5 < e && t.roundingMethod === I.options.roundingMethod.halfEvenBankersRounding || 5 === e && t.roundingMethod === I.options.roundingMethod.halfEvenBankersRounding && 1 === n || 0 < e && t.roundingMethod === I.options.roundingMethod.toCeilingTowardPositiveInfinity && "" === i || 0 < e && t.roundingMethod === I.options.roundingMethod.toFloorTowardNegativeInfinity && "-" === i || 0 < e && t.roundingMethod === I.options.roundingMethod.upRoundAwayFromZero
                }
            }, {
                ...
                value: function(e, t) {
                    var i;
                    i = e.negativeSignCharacter !== I.options.negativeSignCharacter.hyphen ? "([-\\" + e.negativeSignCharacter + "]?)" : "(-?)", t.aNegRegAutoStrip = i, e.allowedAutoStrip = new RegExp("[^-0123456789\\" + e.decimalCharacter + "]", "g"), e.numRegAutoStrip = new RegExp(i + "(?:\\" + e.decimalCharacter + "?([0-9]+\\" + e.decimalCharacter + "[0-9]+)|([0-9]*(?:\\" + e.decimalCharacter + "[0-9]*)?))"), e.stripReg = new RegExp("^" + t.aNegRegAutoStrip + "0*([0-9])"), e.formulaChars = new RegExp("[0-9" + e.decimalCharacter + "+\\-*/() ]")
                }
            }, {
                ...
                value: function(e, t) {
                    var i = void 0;
                    return D.default.isNumber(Number(e)) ? i = D.default.scientificToDecimal(e) : (i = this._convertToNumericString(e.toString(), t), D.default.isNumber(Number(i)) || (D.default.warning('The given value "' + e + '" cannot be converted to a numeric one and therefore cannot be used appropriately.', t.showWarnings), i = NaN)), i
                }
            }, {
                key: "_checkIfInRange",
                value: function(e, t, i) {
                ...
                value: function(e) {
                    var a = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                        ...
                        l = [];
                    "object" === (void 0 === e ? "undefined" : b(e)) && "form" === e.nodeName.toLowerCase() && Array.prototype.slice.call(e.elements).forEach(function(t) {
                        if (t.name && !t.disabled && -1 === ["file", "reset", "submit", "button"].indexOf(t.type))
                            if ("select-multiple" === t.type) Array.prototype.slice.call(t.options).forEach(function(e) {
                                e.selected && (a ? l.push({
                                    name: t.name,
                                    value: e.value
                                }) : l.push(encodeURIComponent(t.name) + "=" + encodeURIComponent(e.value)))
                            });
                            ...
                            D.default.isUndefined(e) && D.default.throwError("This error should never be hit. If it has, something really wrong happened!"), a ? l.push({
                                name: t.name,
                                value: e
                            }) : l.push(encodeURIComponent(t.name) + "=" + encodeURIComponent(e))
                        }
                    });
                    var i = void 0;
        ...
        (t.default = p).multiple = function(e) {
                ...
                var m = D.default.isNumber(i),
                    f = void 0;
                return o && (f = i.length), e.forEach(function(e, t) {
            ...
            return o(r, null, [{
                ...
                value: function(e) {
                    ...
                    window.CustomEvent ? r = new CustomEvent(e, {
                        ...
                        bubbles: n,
                        cancelable: a
                    }) : (r = document.createEvent("CustomEvent")).initCustomEvent(e, n, a, {
                        detail: i
                    }), t.dispatchEvent(r)
                }
            }, {
                ...
                value: function(e) {
                    var t = {},
                        ...
                        a = void 0,
                        r = void 0;
                    if (0 === e && 1 / e < 0 && (e = "-0"), e = e.toString(), this.isNegativeStrict(e, "-") ? (e = e.slice(1), t.s = -1) : t.s = 1, -1 < (i = e.indexOf(".")) && (e = e.replace(".", "")), i < 0 && (i = e.length), (n = -1 === e.search(/[1-9]/i) ? e.length : e.search(/[1-9]/i)) === (a = e.length)) t.e = 0, t.c = [0];
                    else {
                        for (r = a - 1;
                            "0" === e.charAt(r); r -= 1) a -= 1;
                ...
                value: function(e) {
                    ...
                    var l = a.split(/\./),
                        ...
                        h = u[1],
                        d = void 0;
                    return d = o ? "" + (d = c.length > r ? this.insertAt(c, ".", c.length - r) : "0." + "0".repeat(r - c.length) + c) + (h || "") : h ? (a = "" + c + h, r < h.length ? this.insertAt(a, ".", +r + c.length) : "" + a + "0".repeat(r - h.length)) : "" + (a = a.replace(".", "")) + "0".repeat(Number(r)), s && (d = "-" + d), d
                }
            }]), r
        }();
        ...
        Object.freeze(n.allowedTagList), Object.defineProperty(n, "allowedTagList", {
            ...
            configurable: !1,
            writable: !1
        }), Object.freeze(n), t.default = n, e.exports = t.default
    }, function(e, t, i) {
        "use strict";
        var n, a = s(i(0)),
            r = s(i(1));
        ...
        }, n = a.default.options, Object.getOwnPropertyNames(n).forEach(function(e) {
            "valuesToStrings" === e ? Object.getOwnPropertyNames(n.valuesToStrings).forEach(function(e) {
        ...
        }), Object.freeze(n), Object.defineProperty(a.default, "options", {
            configurable: !1,
            writable: !1
        })
    }, function(e, t, i) {
        ...
        var o = function() {
            function i(e) {
                ...
                return function(e, t) {
                    if (!(e instanceof i)) throw new TypeError("Cannot call a class as a function")
                }(this), this.text = e, this.decimalCharacter = t, this.lexer = new r.default(e), this.token = this.lexer.getNextToken(this.decimalCharacter), this._exp()
            }
            return n(i, [{
                key: "_exp",
                value: function() {
        ...
        var o = function() {
            function i(e) {
                ! function(e, t) {
                    if (!(e instanceof i)) throw new TypeError("Cannot call a class as a function")
                }(this), this.text = e, this.textLength = e.length, this.index = 0, this.token = new r.default("Error", 0, 0)
            }
            return n(i, [{
                key: "_skipSpaces",
                value: function() {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            ! function(e, t) {
                if (!(e instanceof i)) throw new TypeError("Cannot call a class as a function")
            }(this), this.type = e, this.value = t, this.symbol = n
        }, e.exports = t.default
    }, function(e, t, i) {
        "use strict";
        ...
        }, Object.freeze(a.default.events.native), Object.freeze(a.default.events), Object.defineProperty(a.default, "events", {
            configurable: !1,
            writable: !1
        })
    }, function(e, t, i) {
        ...
        a(i(3)), n.default.defaultSettings = {
        ...
        }, Object.freeze(n.default.defaultSettings), Object.defineProperty(n.default, "defaultSettings", {
            configurable: !1,
            writable: !1
        })
    }, function(e, t, i) {
        ...
        C.decimalPlaces = 3;
        var F = a.default.cloneObject(s);
        F.currencySymbol = n.default.options.currencySymbol.lira, n.default.predefinedOptions = {
            euro: s,
            euroPos: u,
            euroNeg: c,
            euroSpace: h,
        ...
        }), Object.freeze(n.default.predefinedOptions), Object.defineProperty(n.default, "predefinedOptions", {
            configurable: !1,
            writable: !1
        })
    }])
